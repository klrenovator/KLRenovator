...
const PACKAGES = [
  { name: "1 Bilik Tidur (Studio / 1BR)", subtitle: "Sesuai untuk apartmen studio & kondo 1 bilik", price: "RM 199", includes: ["1× aircond dinding (1.0–1.5 HP)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran", "Pilihan braket luar berbayar jika diperlukan", "Vakum pam", "Waranti kerja 1 bulan"], badge: "Paling Popular untuk Bujang & Pasangan" },
  { name: "2 Bilik Tidur (2BR)", subtitle: "Ideal untuk kondo & apartmen 2 bilik", price: "RM 398", includes: ["2× aircond dinding (1.0–1.5 HP setiap satu)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran ×2", "Pilihan braket luar berbayar jika diperlukan ×2", "Vakum pam ×2", "Waranti kerja 1 bulan"], badge: "Nilai Terbaik untuk Keluarga Kecil", highlight: true },
  { name: "3 Bilik Tidur (3BR)", subtitle: "Penyejukan lengkap untuk rumah landed & kondo 3 bilik", price: "RM 597", includes: ["3× aircond dinding (1.0–2.0 HP ikut keperluan)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran ×3", "Pilihan braket luar berbayar jika diperlukan ×3", "Vakum pam ×3", "Waranti kerja 1 bulan", "Tinjauan tapak & semakan elektrik percuma"], badge: "Perlindungan Seluruh Rumah" },
  { name: "4 Bilik Tidur (4BR+)", subtitle: "Penyejukan penuh untuk rumah landed besar & semi-D", price: "Dari RM 796", includes: ["4+× aircond dinding (pelbagai saiz HP)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran seunit", "Bracket tugas berat jika perlu", "Vakum pam pada setiap unit", "Waranti kerja 1 bulan", "Tinjauan tapak + penilaian kotak DB percuma", "Penjadualan keutamaan — siap dalam 1 hari"], badge: "Penyelesaian Rumah Lengkap" },
];
