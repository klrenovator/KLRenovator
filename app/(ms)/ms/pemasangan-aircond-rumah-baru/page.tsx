...
export const metadata: Metadata = {
  ...
  description: padMetaDescription("Pakej pemasangan aircond rumah baru di KL & Selangor — 1BR, 2BR, 3BR & 4BR. Dari RM199/unit. Harga telus, waranti 1 bulan, servis hari sama."),
  openGraph: {
    title: "Pemasangan Aircond Rumah Baru KL — Pakej Seluruh Rumah",
...
const PACKAGES = [
  { name: "1 Bilik Tidur (Studio / 1BR)", subtitle: "Sesuai untuk apartmen studio & kondo 1 bilik", price: "RM 199", includes: ["1× aircond dinding (1.0–1.5 HP)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran", "Vakum pam", "Waranti kerja 1 bulan"], badge: "Paling Popular untuk Bujang & Pasangan" },
  { name: "2 Bilik Tidur (2BR)", subtitle: "Ideal untuk kondo & apartmen 2 bilik", price: "RM 398", includes: ["2× aircond dinding (1.0–1.5 HP setiap satu)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran ×2", "Vakum pam ×2", "Waranti kerja 1 bulan"], badge: "Nilai Terbaik untuk Keluarga Kecil", highlight: true },
  { name: "3 Bilik Tidur (3BR)", subtitle: "Penyejukan lengkap untuk rumah landed & kondo 3 bilik", price: "RM 597", includes: ["3× aircond dinding (1.0–2.0 HP ikut keperluan)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran ×3", "Vakum pam ×3", "Waranti kerja 1 bulan", "Tinjauan tapak & semakan elektrik percuma"], badge: "Perlindungan Seluruh Rumah" },
  { name: "4 Bilik Tidur (4BR+)", subtitle: "Penyejukan penuh untuk rumah landed besar & semi-D", price: "Dari RM 796", includes: ["4+× aircond dinding (pelbagai saiz HP)", "7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran seunit", "Vakum pam pada setiap unit", "Waranti kerja 1 bulan", "Tinjauan tapak + penilaian kotak DB percuma", "Penjadualan keutamaan — siap dalam 1 hari"], badge: "Penyelesaian Rumah Lengkap" },
];
...
const FAQS = [
  { q: "Berapa kos pemasangan aircond seluruh rumah untuk rumah baru di KL?", a: "Pakej kondo 2BR (2 unit) berharga RM 398, pakej 3BR (3 unit) RM 597, dan pakej 4BR+ bermula dari RM 796. Setiap unit termasuk 7 kaki paip tembaga, penebat, wayar elektrik dan paip saliran, vakum pam, dan waranti kerja 1 bulan. Bahan tambahan melebihi 7 kaki disebut harga dan diluluskan di tapak sebelum kerja bermula. Semua harga disahkan awal — tiada caj tersembunyi." },
  { q: "Berapa lama pemasangan aircond rumah baru mengambil masa?", a: "1BR (1 unit): 3–5 jam. 2BR (2 unit): 5–8 jam. 3BR (3 unit): 1 hari. 4BR+ (5+ unit): 1–2 hari. Kami selalunya boleh siapkan hari sama untuk pemasangan 1–3 unit apabila ditempah sebelum 11 pagi. Pemasangan seluruh rumah dijadualkan lebih awal dengan masa keutamaan." },
  ...
  { q: "Apa perbezaan antara pemasangan kondo dan rumah landed?", a: "Kondo perlu kelulusan JMB, tempahan lif/ruang muatan, dan mungkin ada sekatan tebing servis. Rumah landed lebih fleksibel dalam penempatan unit luar dan penjadualan lebih pantas. Kedua-duanya menggunakan bahan berkualiti sama (paip tembaga Type L, penebat, litar khusus). Harga sama untuk unit dinding." },
...
export default function PemasanganAircondRumahBaruPage() {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: <FaClipboardList className="h-5 w-5" />, title: "Spesifikasi Bahan", desc: "Paip tembaga Type L, penebat 9–13mm, pendawaian 2.5mm²/4mm² ikut piawaian Malaysia. Setiap bahan disahkan dengan anda sebelum kerja." },
      ...
      <PageExplainers locale="ms" presetId="install:new-home" />
    </>
  );
}
