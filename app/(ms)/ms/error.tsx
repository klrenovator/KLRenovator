  ...
  return (
    <div className="mx-auto flex max-w-xl flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <p className="mt-3 text-sm text-slate-600">
        Ralat yang tidak dijangka telah berlaku. Anda boleh cuba lagi, atau
        WhatsApp kami terus untuk perkhidmatan lebih pantas.
      </p>
      <button
        onClick={() => reset()}
      ...
      >
        <FiRefreshCw className="h-4 w-4" /> Cuba lagi
      </button>
    </div>
  );
}
