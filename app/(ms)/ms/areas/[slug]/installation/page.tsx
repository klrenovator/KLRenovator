...
export async function generateMetadata({
  ...
  if (!area) return { title: "Kawasan tidak dijumpai" };

  const c = getAreaInstallationContent(slug, "ms");
...
export default async function AreaInstallationPageMS({
  params,
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return <AreaInstallationLandingPage slug={slug} locale="ms" />;
}
