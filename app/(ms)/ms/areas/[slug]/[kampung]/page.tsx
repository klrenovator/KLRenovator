...
export async function generateMetadata({
  ...
  return {
    title: buildFreshMetaTitle(k.metaTitleMS || k.metaTitle, "ms"),
...
export default async function KampungPageMS({
  ...
  const gamePlan = kampungGamePlan(k, parentArea, "ms");
  const signals = kampungSignals(k, parentArea, "ms");

  // HowTo JSON-LD sepadan dengan <ol> langkah yang dipaparkan (isu #65).
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            ...
            <h2 className="mt-6 text-xl sm:text-2xl font-black tracking-tight text-slate-950">
              Apakah yang termasuk dalam servis aircond di {k.name}?
            </h2>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            ...
            <h2 className="mt-8 text-xl sm:text-2xl font-black tracking-tight text-slate-950">
              Bagaimana nak tempah servis aircond di {k.name}?
            </h2>
      ...
      {/* Content depth §71 — local signals (MS) */}
