...
const GALLERY_IMAGES = [
  { src: "/hero/aircond-installation-kuala-lumpur.webp", alt: "KL Renovator technician installing a wall-mounted aircond unit in a Kuala Lumpur apartment" },
  { src: "/hero/aircond-installation-wall-mounted-kl.webp", alt: "Indoor wall-mounted aircond unit neatly installed with concealed piping in a Selangor home" },
  { src: "/hero/aircond-ceiling-cassette-installation-commercial.webp", alt: "Ceiling cassette aircond unit being fitted in a commercial office space in KL" },
  { src: "/hero/aircond-new-installation-rawang-selangor.webp", alt: "Completed new aircond installation showing indoor unit and neat cable routing in Rawang" },
  { src: "/hero/aircond-pressure-chemical-wash-selangor.webp", alt: "Technician applying pressure chemical wash to clean mould and dust from aircond evaporator coil" },
  { src: "/hero/aircond-repair-technician-klang-valley.webp", alt: "KL Renovator HVAC technician diagnosing aircond fault using professional testing equipment" },
  { src: "/hero/aircond-new-compressor-installation-rawang.webp", alt: "Replacement compressor installed on an aircond outdoor unit at a Rawang residential property" },
  { src: "/hero/aircond-compressor-flaring-repair-kl.webp", alt: "Copper pipe flaring repair on aircond compressor to fix refrigerant leak in Kuala Lumpur" },
  { src: "/hero/aircond-compressor-bracket-installation-kl.webp", alt: "Heavy-duty outdoor bracket installed for aircond compressor unit in Kuala Lumpur" },
  { src: "/hero/aircond-installation-double-unit-kl.webp", alt: "Two wall-mounted aircond units installed side by side in a Kuala Lumpur home" },
  { src: "/hero/aircond-gas-topup-r32-r410a-selangor.webp", alt: "Refrigerant gas top-up being performed with manifold gauge on aircond unit in Selangor" },
  { src: "/hero/aircond-compressor-installation-new-kl.webp", alt: "Brand new aircond outdoor compressor unit being connected and sealed by KL Renovator technician" },
  { src: "/hero/aircond-pcb-board-replacement-kl.webp", alt: "Faulty PCB board replaced with new unit inside aircond indoor unit in Kuala Lumpur" },
  { src: "/hero/aircond-installation-ampang-selangor.webp", alt: "Wall-mounted aircond installation completed in an Ampang condominium unit" },
  { src: "/hero/aircond-chemical-service-canvas-wrap-kl.webp", alt: "Canvas protection laid out before chemical service to keep customer's home clean in KL" },
  { src: "/hero/aircond-pcb-board-replacement-2-klang-valley.webp", alt: "Aircond PCB board replacement in progress — old board removed and new one wired in Klang Valley" },
  { src: "/hero/aircond-bracket-installation-kl-renovator.webp", alt: "Outdoor compressor bracket securely mounted on wall during aircond installation by KL Renovator" },
  { src: "/hero/aircond-chemical-wash-canvas-kepong-kl.webp", alt: "Canvas-wrapped chemical wash in progress to protect walls and furniture at a Kepong property" },
  { src: "/hero/aircond-sensor-replacement-klang-valley.webp", alt: "Temperature sensor replacement on aircond unit restoring proper cooling cycle in Klang Valley" },
];
