...
export const metadata: Metadata = {
  title: "Aircond Chemical Wash KL & Selangor 2026 — From RM120 | KL Renovator",
  ...
  alternates: {
    canonical: "https://www.klrenovator.com/cuci-aircond-kl",
    languages: {
  ...
  openGraph: {
    title: "Aircond Chemical Wash KL — RM120 | KL Renovator",
...
const faqs = [
  { q: "How much is aircond chemical wash in KL 2026?", a: "RM120 for wall-mounted 1.0–1.5 HP. 2.0–2.5 HP RM150. 3.0 HP RM180. Cassette from RM220. Price confirmed before work. Multi-unit: 5%/10%/15% off." },
