...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "https://www.klrenovator.com/hero/aircond-ceiling-cassette-installation-commercial.webp", width: 1200, height: 630, alt: "Pemasangan Aircond Komersial KL Selangor" }],
  },
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center bg-slate-900 overflow-hidden">
        <Image src="/hero/aircond-ceiling-cassette-installation-commercial.webp" alt="Pemasangan aircond komersial pejabat kedai restoran KL Selangor" fill priority sizes="100vw" className="object-cover object-center opacity-40" quality={80} />
      ...
      <section className="py-20 sm:py-28 bg-slate-50" id="amc">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delay={300}><div className="max-w-2xl mx-auto bg-indigo-600 text-white rounded-2xl p-8 text-center"><h3 className="font-black text-xl mb-2">Pakej AMC Komersial</h3><div className="grid grid-cols-2 gap-4 mt-6 text-left"><div className="bg-white/10 rounded-xl p-4"><p className="text-xs text-indigo-200 mb-1">5–10 Unit</p><p className="font-black text-2xl">RM 1,999<span className="text-sm font-normal text-indigo-200">/tahun</span></p></div><div className="bg-white/10 rounded-xl p-4"><p className="text-xs text-indigo-200 mb-1">10+ Unit</p><p className="font-black text-2xl">RM 3,499<span className="text-sm font-normal text-indigo-200">/tahun</span></p></div></div><a href={waLink("📋 Pertanyaan Kontrak AMC\n\nHi KL Renovator, saya berminat dengan pelan AMC komersial.\n\n🏢 Jenis Perniagaan:\n🔢 Bilangan Unit:\n📍 Lokasi:\n\nSila hantar butiran & harga AMC.")} target="_blank" rel="nofollow noopener noreferrer" className="inline-flex items-center gap-2 mt-6 bg-white hover:bg-indigo-50 text-indigo-700 font-black uppercase text-sm tracking-widest px-8 py-4 rounded-xl transition-all"><FaWhatsapp className="h-4 w-4" /> Tanya Tentang AMC</a></div></Reveal>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-28 bg-slate-900 text-white">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center"><Reveal>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 flex flex-wrap justify-center gap-4">
            ...
            <Link href="/ms/services/maintenance-contract" className="text-sm text-slate-400 hover:text-white transition-colors">Butiran AMC</Link>
