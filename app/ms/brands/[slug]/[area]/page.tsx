      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          <p className="text-slate-700 font-medium leading-relaxed mb-6">
            KL Renovator menghantar juruteknik bertauliah terus ke kediaman, kondominium, kedai, atau pejabat anda di {area.name}. Kami sangat memahami sistem elektronik, papan litar, dan keperluan tekanan gas untuk setiap unit {brand.name}. Sama ada servis asas, overhaul kimia mendalam, atau pengimbangan tekanan gas, kami sedia membantu dengan cepat.
          </p>
