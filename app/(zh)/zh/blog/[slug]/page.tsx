...
export async function generateMetadata({
  ...
  return {
    ...
    description: ensureCtaDescription(padMetaDescription(post.excerptZH)),
    openGraph: {
...
export default async function BlogPostPageZH({
  ...
  return <BlogPostClient post={sanitizeBlogPost(post)} related={related} forcedLang="zh" explainers={explainersForPost(post)} />;
}
