...
export const metadata: Metadata = {
  ...
  description: padMetaDescription("专业冷气安装RM199起 — 挂壁式、天花板卡式机、窗式机，覆盖20个品牌。真空泵、铜管、1个月工艺保修。当天可预约。WhatsApp +60182983573"),
  openGraph: {
...
const INSTALLATION_PROCESS = [
  ...
  { step: 7, title: "释放制冷剂、测试与交付", desc: "释放出厂预充制冷剂。系统运行15+分钟。我们验证：制冷输出（送/回风温差）、运行压力、电流、温控器校准、零振动、零泄漏。书面1个月工艺保修卡交付。签署带清单的工单。", icon: <span aria-hidden="true">🌡️</span> },
];
...
const CRO_TITLE = "为何选择 KL Renovator 安装？";
const CRO_SUBTITLE = "专业冷气安装RM199起 — 当天服务，全品牌，1个月工艺保修。";
...
export default function AircondInstallationKLZHPage() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
          <Reveal>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <TrustBadge icon="🕘" label="当天可预约" />
              <TrustBadge icon="🛡️" label="1个月工艺保修" />
              <TrustBadge icon="🚚" label="20大品牌全支持" />
            </div>
            <div className="mt-8 flex flex-col sm:flex-row gap-4 max-w-md">
              <a href={waLink("🔧 冷气安装咨询\n\n你好KL Renovator，我要装新冷气。\n\n📍 我的区域：\n❄️ 机型：挂壁式 / 天花板卡式机 / 窗式机\n📏 匹数（如知道）：\n🏠 物业：公寓 / 排屋 / 办公室 / 店铺\n\n请报价并提供可用时段。")} target="_blank" rel="nofollow noopener noreferrer" className="flex-1 inline-flex items-center justify-center gap-2.5 bg-[#22c55e] hover:bg-[#16a34a] text-white font-black uppercase text-sm tracking-widest h-14 px-6 shadow-lg shadow-green-900/40 transition-all">
                <span aria-hidden="true">💬</span> WhatsApp预约安装
              </a>
              <a href={`tel:${siteConfig.phone}`} className="flex-1 inline-flex items-center justify-center gap-2.5 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 hover:border-white/50 text-white font-black uppercase text-sm tracking-widest h-14 px-6 transition-all">
                <span aria-hidden="true">📞</span> 致电 +60 18-298 3573
              </a>
            </div>
          </Reveal>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delay={200}>
            <div className="mt-6 bg-emerald-50 border border-emerald-100 rounded-2xl p-6">
              <h3 className="font-black text-emerald-800 mb-3 flex items-center gap-2"><span aria-hidden="true">✓</span> 人工费包含项目</h3>
              <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-emerald-700">
                <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 免费现场勘察报价</li>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { icon: <span aria-hidden="true">🏢</span>, title: "公寓/JMB专家", desc: "熟悉大厦审批、电梯预约、服务阳台进出、非办公时段规定。" },
              { icon: <span aria-hidden="true">❄️</span>, title: "覆盖20大主流品牌", desc: "大金、松下、三菱、约克、美的、LG、三星、开利、富士通、日立、夏普、Acson、格力、东芝、海信、Aux、TCL、Isonic、National、三洋。" },
              { icon: <span aria-hidden="true">📍</span>, title: "全吉隆坡雪兰莪服务", desc: "八打灵再也、蕉赖、安邦、梳邦、蒲种、莎阿南、白沙罗、巴生、加影、孟沙、满家乐、武吉洞、布城、赛城。" },
            ].map((item, i) => (
            ...
            <Reveal delay={100}>
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> Type L铜管（1.0–2.5匹）— 壁厚、抗腐蚀强</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> Type M铜管（3.0匹+）— 大匹数认可规格</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 焊接通氮气 — 防内部氧化</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 扩口扭力扳手按规范拧紧</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 无扁折、急弯、管径不足</li>
                </ul>
              </div>
            </Reveal>
            <Reveal delay={150}>
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6">
                ...
                <ul className="space-y-2 text-sm text-slate-600">
                  ...
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 全覆盖 — 无裸露铜管</li>
                </ul>
              </div>
            </Reveal>
            <Reveal delay={200}>
              <div className="bg-slate-50 border border-slate-100 rounded-2xl p-6">
                <h3 className="font-black text-slate-900 mb-4 flex items-center gap-2"><span aria-hidden="true">⚡</span> 电气与支架</h3>
                <ul className="space-y-2 text-sm text-slate-600">
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 从配电箱拉独立回路 — MCB按匹数选型</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 2.5mm²线（1.0–2.5匹）、4mm²（3.0–5.0匹）</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 室外机隔离开关 — 安全与维修方便</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 重型支架 — 防震、粉末涂层防锈</li>
                  <li className="flex items-center gap-2"><span aria-hidden="true">✓</span> 线槽保护 — 整洁、可刷漆</li>
                </ul>
              </div>
            </Reveal>
          </div>
          ...
          <Reveal delay={300}>
            <div className="mt-12 text-center">
              ...
              <a href={waLink("🔧 安装报价申请\n\n你好KL Renovator，我要确认冷气安装价格。\n\n📍 区域：\n❄️ 机型：\n📏 匹数：\n🏠 物业类型：\n\n请发完整明细。")} target="_blank" rel="nofollow noopener noreferrer" className="inline-flex items-center gap-2.5 bg-[#22c55e] hover:bg-[#16a34a] px-8 py-4 text-sm font-black uppercase tracking-widest text-white transition-all rounded-xl">
                <span aria-hidden="true">💬</span> WhatsApp获取确认报价
              </a>
            </div>
          </Reveal>
        </div>
      ...
      <InstallationDeferred locale="zh" title={CRO_TITLE} subtitle={CRO_SUBTITLE} />
          ...
          <Reveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={waLink("🔧 冷气安装预约\n\n你好KL Renovator，我要预约安装。\n\n📍 我的区域：\n❄️ 机型：挂壁式 / 天花板卡式机 / 窗式机\n📏 匹数：\n🏠 物业：公寓 / 排屋 / 办公室\n\n心仪日期：\n\n请确认报价与时段。")} target="_blank" rel="nofollow noopener noreferrer" className="inline-flex items-center justify-center gap-2.5 bg-[#22c55e] hover:bg-[#16a34a] px-8 py-4 text-sm font-black uppercase tracking-widest text-white transition-all rounded-xl">
                <span aria-hidden="true">💬</span> WhatsApp预约
              </a>
      ...
      <PageExplainers locale="zh" presetId="install:kl" />
    </>
  );
}