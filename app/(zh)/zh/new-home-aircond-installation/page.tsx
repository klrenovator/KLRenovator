...
const PACKAGES = [
  { name: "1房 (Studio / 1BR)", subtitle: "适合单身公寓和一房式公寓", price: "RM 199", includes: ["1× 挂壁式冷气 (1.0–1.5 HP)", "7尺铜管、电线、排水管", "真空泵调试", "1个月工艺保修"], badge: "单身及情侣首选" },
  { name: "2房 (2BR)", subtitle: "适合两房式公寓", price: "RM 398", includes: ["2× 挂壁式冷气 (每台1.0–1.5 HP)", "7尺铜管、电线、排水管 ×2", "真空泵调试 ×2", "1个月工艺保修"], badge: "小家庭最佳价值", highlight: true },
  { name: "3房 (3BR)", subtitle: "3房排屋及公寓的完整制冷方案", price: "RM 597", includes: ["3× 挂壁式冷气 (根据需要1.0–2.0 HP)", "7尺铜管、电线、排水管 ×3", "真空泵调试 ×3", "1个月工艺保修", "免费现场勘察及电力检查"], badge: "全屋覆盖" },
...
const FAQS = [
  { q: "吉隆坡新房全屋冷气安装费用是多少？", a: "2BR公寓套餐（2台）RM 398，3BR套餐（3台）RM 597，4BR+套餐RM 796起。每台包含7尺铜管、电线、排水管、真空泵调试和1个月工艺保修。超出7尺的额外材料在施工前现场报价并获批准。所有价格事先确认 — 无隐藏费用。" },
  ...
  { q: "公寓和排屋冷气安装有什么不同？", a: "公寓需要JMB审批、预约电梯/卸货区，可能有服务阳台限制。排屋在室外机放置上更灵活，排期通常更快。两者使用相同优质材料（Type L铜管、保温、专用电路）。挂壁式机型价格相同。" },
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center bg-slate-900 overflow-hidden">
        <Image src="/logo/image.png" alt="新房冷气安装套餐 吉隆坡 雪兰莪" fill priority sizes="100vw" className="object-cover object-center opacity-40" quality={80} />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              { icon: <FaClipboardList className="h-5 w-5" />, title: "材料规格", desc: "Type L铜管、9–13mm保温层、2.5mm²/4mm²马来西亚标准电线。每种材料在施工前与您确认。" },
      ...
      <PageExplainers locale="zh" presetId="install:new-home" />
    </>
  );
}
