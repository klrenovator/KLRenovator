...
const t = TOPIC_HUBS.maintenance.copy.zh;

export const metadata: Metadata = {
  title: clampMetaTitle(t.metaTitle),
  description: padMetaDescription(t.metaDescription),
  alternates: buildTrilingualHreflang("/maintenance", "zh"),
  openGraph: {
    title: clampMetaTitle(t.metaTitle),
    description: padMetaDescription(t.metaDescription),
    url: "https://www.klrenovator.com/zh/maintenance",
    type: "website",
    locale: "zh_MY",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "冷气保养与维修指南 吉隆坡雪兰莪 — KL Renovator",
      },
    ],
  },
};
...
export default function Page() {
  return <TopicHubPage hubId="maintenance" locale="zh" />;
}
