...
export const metadata: Metadata = {
  title: "Commercial Aircond Installation KL & Selangor — Office, Shoplot, B2B | KL Renovator",
  description: "Commercial aircond installation for offices, shoplots, restaurants, clinics & server rooms across KL & Selangor. Ceiling cassette, ducted, multi-split systems. AMC available. WhatsApp +60182983573",
  openGraph: {
    title: "Commercial Aircond Installation KL & Selangor — Office, Shoplot, B2B | KL Renovator",
    ...
    images: [{ url: "https://www.klrenovator.com/hero/aircond-ceiling-cassette-installation-commercial.webp", width: 1200, height: 630, alt: "Commercial Aircond Installation KL Selangor" }],
  },
  twitter: { card: "summary_large_image", title: "Commercial Aircond Installation KL & Selangor — B2B | KL Renovator", description: "Office, shoplot, restaurant, clinic & server room aircond installation. Ceiling cassette, ducted, multi-split systems. AMC available. WhatsApp +60182983573", images: ["https://www.klrenovator.com/hero/aircond-ceiling-cassette-installation-commercial.webp"] },
...
const FAQS = [
  { q: "How much does commercial aircond installation cost in KL for an office?", a: "Wall-mounted commercial installation starts from RM 199 (1.5 HP) for small offices. Ceiling cassette installation from RM 290 (1.0–1.5 HP) up to RM 400 (3.5–6.0 HP). Each price includes 7 ft copper pipe, wiring, drain pipe, brackets/suspension kit, vacuum pump commissioning, and 1-month workmanship warranty. Extra materials quoted and approved on-site." },
  { q: "Can you install aircond outside business hours to avoid disrupting my operations?", a: "Yes — we specialise in after-hours commercial installation. Evening slots (6 PM–10 PM), weekends, and public holidays available. For restaurants, we can work between closing and opening hours. Office installations typically scheduled weekends. No extra charge for after-hours work — it's standard for our commercial clients." },
  ...
  return (
    <>
      ...
      <section className="relative min-h-[70vh] sm:min-h-[80vh] flex items-center justify-center bg-slate-900 overflow-hidden">
        <Image src="/hero/aircond-ceiling-cassette-installation-commercial.webp" alt="Commercial aircond installation office shoplot restaurant KL Selangor" fill priority sizes="100vw" className="object-cover object-center opacity-40" quality={80} />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <Reveal delay={300}><div className="max-w-2xl mx-auto bg-indigo-600 text-white rounded-2xl p-8 text-center">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 text-left">
              <div className="bg-white/10 rounded-xl p-4"><p className="text-xs text-indigo-200 mb-1">5–10 Units</p><p className="font-black text-2xl">RM 1,999<span className="text-sm font-normal text-indigo-200">/year</span></p></div>
              <div className="bg-white/10 rounded-xl p-4"><p className="text-xs text-indigo-200 mb-1">10+ Units</p><p className="font-black text-2xl">RM 3,499<span className="text-sm font-normal text-indigo-200">/year</span></p></div>
            </div>
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
          <Reveal>
            ...
            <div className="mt-8 pt-6 border-t border-slate-800 flex flex-wrap justify-center gap-4">
              ...
              <Link href="/services/maintenance-contract" className="text-sm text-slate-400 hover:text-white transition-colors">AMC Details</Link>
