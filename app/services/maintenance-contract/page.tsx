...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you offer AMC for commercial premises with multiple units?", acceptedAnswer: { "@type": "Answer", text: "Yes — KL Renovator provides custom AMC plans for offices, retail shops, restaurants, clinics, and other commercial premises with 2–50+ aircond units. Volume discounts apply: 5% off for 2–3 units, 10% for 4–8 units, 15% for 8+ units. WhatsApp us your unit count and type for a custom commercial AMC proposal." } },
  ],
};
