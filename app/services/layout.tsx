...
export const metadata: Metadata = {
  ...
  description:
    "Full aircond service price list for KL & Selangor — chemical wash from RM 160, chemical overhaul from RM 220, gas top-up, installation, repair. Transparent pricing, no hidden fees.",
  alternates: {
