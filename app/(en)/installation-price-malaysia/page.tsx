        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              { title: buildFreshMetaTitle("7ft Copper Pipe (Correct Size)", "en"), desc: `Pipe diameter matched to your unit's HP — not universal thin pipe. ${entityPhrases.armaflexStandard}` },
