...
import type { BlogPostSummary } from "@/config/blog-posts";
...
// most posts.
function localized(post: BlogPostSummary, lang: Lang) {
  return {
...
export default function BlogIndexClient({ posts, initialLang = "en" }: { posts: BlogPostSummary[]; initialLang?: Lang }) {
