...
export default function FaqLayout({ children }: { children: React.ReactNode }) {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes. 5+ units: 5% OFF Instant Booking Discount. 10+ units: 10% OFF Instant Booking Discount. Discounts apply to labour charges. WhatsApp +60182983573 to confirm.",
        },
      },
      {
        "@type": "Question",
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "FAQ", "item": "https://www.klrenovator.com/faq" },
    ],
  };
