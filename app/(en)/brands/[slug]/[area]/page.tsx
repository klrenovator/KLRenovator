    ...
    <>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="mx-auto max-w-4xl px-4">
          ...
          {/* Content depth §71 — first-visit plan (per brand-family × area-profile) */}
          ...
          {/* Content depth §71 — common jobs table */}
          ...
          <LocalPriceComparisonTable locale="en" name={`${brand.name} in ${area.name}`} />
          <ExpertReviewBlock locale="en" name={`${brand.name} in ${area.name}`} context="brand-area" seed={`brand-area-${brand.slug}-${area.slug}-en`} />
          ...
          <div className="mb-10">
            <MoneyCrossLinks block={brandAreaLocalLinks(slug, brand.name, areaSlug, area.name, "en")} />
          </div>
