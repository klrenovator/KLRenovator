...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Do you offer AMC for commercial premises with multiple units?", acceptedAnswer: { "@type": "Answer", text: "Yes — KL Renovator provides custom AMC plans for offices, retail shops, restaurants, clinics, and other commercial premises with 2–50+ aircond units. Volume discounts apply: 5% OFF Instant Booking Discount for 5+ units, 10% OFF Instant Booking Discount for 10+ units. WhatsApp us your unit count and type for a custom commercial AMC proposal." } },
  ],
};
...
const plans = [
  ...
  { name: "Premium", price: "899", period: "/year", color: "bg-amber-600", border: "border-amber-300", badging: "Maximum Protection", services: "7 visits/year", includes: ["4 Basic Servicing visits (quarterly)", "2 Pressure Chemical Washes", "1 Chemical Overhaul (Wall-Mounted Aircon only, RM 420 value)", "2 Free Emergency Diagnostics (RM 176 value)", "Priority + same-day + after-hours response", "15% off any additional repair labour", "Free gas pressure check on every visit"], icon: "\ud83d\udc51" },
];
    ...
    <>
      ...
      <section className="py-16 px-4 bg-gradient-to-br from-sky-700 to-slate-800 text-white text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-sky-200 mb-8 text-sm max-w-md mx-auto">Join {reviewCountLabel} Klang Valley customers who trust KL Renovator with their aircond maintenance. WhatsApp us now — we will recommend the right plan for you.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={amcWaLink} target="_blank" rel="nofollow noopener noreferrer" className="inline-flex items-center justify-center gap-3 bg-[#22c55e] hover:bg-[#16a34a] text-white font-black uppercase tracking-wider px-8 py-4 rounded-2xl text-sm shadow-xl transition-all">
      ...
      {/* Topic hub (issue #66) */}
      <TopicHubCta hubId="maintenance" locale="en" />
