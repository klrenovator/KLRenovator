...
const TEXT = {
  en: {
    ...
    note: "This guide helps you choose more confidently, while the technician still confirms the diagnosis and quote before work starts.",
    triggers: ["Choose this service if", "Consider a lighter option if", "Escalate first if"],
    outcomes: ["Recommended option", "Lighter option", "Urgent option"],
  ...
  ms: {
    ...
    note: "Panduan ini membantu anda memilih dengan lebih yakin, sementara juruteknik tetap mengesahkan diagnosis dan harga sebelum kerja bermula.",
    triggers: ["Pilih servis ini jika", "Pertimbangkan pilihan ringan jika", "Naikkan skop dahulu jika"],
    outcomes: ["Pilihan disyorkan", "Pilihan lebih ringan", "Pilihan segera"],
  ...
  zh: {
    ...
    note: "此指南帮助您更有信心地选择服务；技师仍会在开工前确认诊断和报价。",
    triggers: ["选择此服务，如果", "考虑较轻选择，如果", "先升级处理，如果"],
    outcomes: ["推荐选择", "较轻选择", "紧急选择"],
