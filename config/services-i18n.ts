...
export const serviceI18n: Record<string, ServiceI18n> = {
  ...
  emergency: {
    ...
    processMS: [
      ...
      { step: "Dapatkan Harga Disahkan", desc: "Caj diagnostik dikuotakan terlebih dahulu. Anggaran julat pembaikan dikongsi berdasarkan penerangan anda — kapasitor ~RM 230, motor kipas RM 350–480, PCB RM 400–600. Tiada bil kejutan." },
    ...
    processZH: [
      ...
      { step: "获取确认报价", desc: "诊断费提前报价。根据您的描述分享预估维修范围 — 电容器约RM 230，风扇电机RM 350-480，PCB RM 400-600。无意外费用。" },
