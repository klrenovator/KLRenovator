...
export const serviceI18n: Record<string, ServiceI18n> = {
  ...
  "chemical-wash": {
    ...
    titleZH: "高压化学清洗",
    taglineMS:
      "Pembersihan kimia tekanan tinggi semasa unit kekal terpasang — membunuh kulat, melarutkan biofilm, memulihkan penyejukan. Dari RM 120.",
    taglineZH:
      "机器保持挂墙状态进行高压化学深度清洁——杀灭霉菌、溶解生物膜、恢复制冷。从RM 120起。",
    descriptionMS:
      "Aircond anda telah beroperasi 8 jam sehari selama 12 bulan. Penapis menangkap habuk — tetapi bagaimana dengan gegelung penyejat dan roda kipas? Sirip dan bilah tersebut kini disaluti lapisan tebal dan lembap kulat, biofilm, hama habuk, dan enap cemar bakteria. Itulah sebabnya udara berbau hapak. Itulah sebabnya penyejukan lemah walaupun termostat menunjukkan 16°C. Cuci kimia tekanan adalah penyelesaiannya: juruteknik kami menyembur larutan kimia alkali selamat dimakan pada 80–120 PSI terus ke gegelung dan roda kipas semasa unit kekal terpasang di dinding anda. Kimia melarutkan biofilm dalam beberapa minit. Bilasan air tekanan tinggi kemudian membilas setiap bahan cemar terlarut keluar melalui paip longkang. Hasilnya: output penyejukan dipulihkan ke tahap hampir baharu, bau hapak dihapuskan, dan aliran udara kuat semula — semuanya dalam kira-kira 60–75 minit tanpa membuka unit. RM 120 untuk dinding 1.0–1.5 HP.",
    descriptionZH:
      "您的冷气每天运转8小时，持续12个月。过滤网能拦截灰尘——但蒸发器盘管和风轮呢？那些翅片和叶片现在覆盖着一层又厚又湿的霉菌、生物膜、尘螨和细菌淤泥。这就是为什么有霉味。这就是为什么即使温控器显示16°C制冷依然很弱。高压化学清洗就是解决方案：我们的技术员以80-120 PSI将食品级安全碱性化学溶液直接喷到盘管和风轮上，而机器保持挂墙状态。化学溶液在几分钟内溶解生物膜。然后高压水冲洗将所有溶解的污染物通过排水管冲出。效果：制冷输出恢复到接近新机水平，霉味消除，风量恢复强劲——全部在约60-75分钟内完成，无需拆卸机器。挂壁式1.0-1.5 HP RM 120。",
    highlightsMS: [
