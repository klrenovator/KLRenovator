...
export const serviceI18n: Record<string, ServiceI18n> = {
  ...
  "ceiling-cassette": {
    ...
    highlightsMS: [
      ...
      "Overhaul kimia untuk unit wall-mounted — pembongkaran penuh dan setiap komponen dicuci mendalam",
  ...
  emergency: {
    ...
    processMS: [
      ...
      { step: "Dapatkan Harga Disahkan", desc: "Caj diagnostik dikuotakan terlebih dahulu. Anggaran julat pembaikan dikongsi berdasarkan penerangan anda — kapasitor ~RM 230, motor kipas RM 300–400, PCB RM 400–600. Tiada bil kejutan." },
    ...
    processZH: [
      ...
      { step: "获取确认报价", desc: "诊断费提前报价。根据您的描述分享预估维修范围 — 电容器约RM 230，风扇电机RM 300-400，PCB RM 400-600。无意外费用。" },
    ...
    priceTableMS: [
      ...
      { label: "Penggantian Kapasitor (kecemasan paling biasa)", price: "RM 230" },
      { label: "Penggantian Motor Kipas (dalaman)", price: "RM 300–400" },
      { label: "Penggantian Motor Kipas (luar)", price: "RM 300–450" },
      { label: "Penggantian Papan PCB", price: "RM 400–600" },
      { label: "Pembersihan Paip Longkang Kecemasan", price: "RM 170" },
      { label: "Penggantian Kompresor (dikuotakan sebelum kerja)", price: "RM 850–2,000" },
    ],
    priceTableZH: [
      { label: "诊断费（标准时间 上午9点–下午6点）", price: "RM 88" },
      { label: "诊断费（同次维修则免收）", price: "免费" },
      { label: "非工作时间加收（下午6点–晚上10点）", price: "RM 50" },
      { label: "电容器更换（最常见的紧急情况）", price: "RM 230" },
      { label: "风扇电机更换（室内）", price: "RM 300–400" },
      { label: "风扇电机更换（室外）", price: "RM 300–450" },
      { label: "PCB板更换", price: "RM 400–600" },
      { label: "紧急疏通排水管", price: "RM 170" },
      { label: "压缩机更换（开工前报价）", price: "RM 850–2,000" },
    ],
  },
};
