  ...
  installation: {
    en: {
      ...
      howItWorks: [
        ...
        "Add optional items: Small PVC casing (electrical wire) RM 6/ft or large PVC casing (copper pipe + wire + insulation) RM 12/ft, outdoor bracket (standard RM 45 or heavy duty RM 70), aircond switch / plug point (RM 100), wall hacking & concealment work (RM 25/ft) and a condensate water pump for concealed installs.",
        "The calculator applies the instant booking bundle discount — 5% OFF for 5+ units and 10% OFF for 10+ units — and shows your full line-item breakdown.",
      ...
      factors: [
        ...
        { title: "Wall hacking & concealment", desc: "Want the copper pipe and wiring hidden inside the wall instead of in surface casing? Wall hacking & concealment work is RM 25/ft — it covers hacking the chase, laying the concealed piping and patching back. Charged by the actual concealed run length." },
        { title: "Bundle discount", desc: "Install 5+ units and get 5% OFF; 10+ units get 10% OFF. The discount applies to the whole installation package." },
      ],
      faqs: [
        ...
        { q: "Is there a discount for installing multiple aircond units?", a: "Yes — KL Renovator gives an instant booking discount on multi-unit installations: 5% OFF for 5+ units and 10% OFF for 10+ units. This is applied automatically in the calculator and on your final quotation." },
        ...
        { q: "How much does wall hacking and concealed aircond piping cost?", a: "Wall hacking & concealment work is RM 25/ft, charged by the actual length of pipe run concealed inside the wall. It covers hacking the chase, running the concealed copper pipe, wiring and drain, and patching the wall back. Choose it in the calculator instead of PVC casing when you want a completely hidden installation; the final scope is confirmed on-site." },
    ...
    ms: {
      ...
      howItWorks: [
        ...
        "Tambah item pilihan: casing PVC kecil (wayar elektrik) RM 6/kaki atau casing PVC besar (paip kuprum + wayar + penebat) RM 12/kaki, pendakap luar (standard RM 45 atau heavy duty RM 70), suis / plug point aircond (RM 100), kerja pecah dinding & penyembunyian paip (RM 25/kaki) dan pam air untuk pemasangan tersembunyi.",
        "Kalkulator menggunakan diskaun tempahan segera — 5% OFF untuk 5+ unit dan 10% OFF untuk 10+ unit — serta menunjukkan pecahan penuh setiap item.",
      ...
      factors: [
        ...
        { title: "Pecah dinding & penyembunyian paip", desc: "Mahu paip tembaga dan pendawaian disembunyikan di dalam dinding dan bukan dalam casing? Kerja pecah dinding & penyembunyian ialah RM 25/kaki — termasuk memecah laluan, memasang paip tersembunyi dan menampal semula. Dicaj mengikut panjang laluan tersembunyi sebenar." },
        { title: "Diskaun pakej", desc: "Pasang 5+ unit dan dapat 5% OFF; 10+ unit dapat 10% OFF. Diskaun dikenakan pada keseluruhan pakej pemasangan." },
      ],
      faqs: [
        { q: "Berapakah kos pemasangan aircond di Malaysia?", a: "Pemasangan dinding bermula dari RM 199 untuk 1.0–1.5 HP termasuk 7 kaki paip tembaga, wayar dan paip saliran, commissioning pam vakum dan waranti mutu kerja 1 bulan. Ceiling cassette dari RM 290, unit tingkap dari RM 199. 2.0 HP RM 249, 2.5 HP RM 279, 3.0 HP RM 329, 4.0 HP RM 399 dan 5.0 HP RM 449." },
        ...
        { q: "Adakah diskaun untuk pemasangan berbilang unit aircond?", a: "Ya — KL Renovator memberi diskaun tempahan segera untuk pemasangan berbilang unit: 5% OFF untuk 5+ unit dan 10% OFF untuk 10+ unit. Ini dikira automatik dalam kalkulator dan pada sebut harga akhir anda." },
        { q: "Apa yang termasuk dalam pakej RM 199?", a: "Pakej RM 199 (1.0–1.5 HP dinding) termasuk 7 kaki paip tembaga, 7 kaki wayar, 7 kaki paip saliran, commissioning pam vakum, buruh pemasangan penuh dan waranti mutu kerja bertulis 1 bulan. Apa-apa melebihi 7 kaki, atau item tambahan seperti casing PVC, suis aircond atau pam air, dicaj berasingan mengikut kadar yang diterbitkan." },
        { q: "Berapakah kos kerja pecah dinding & paip tersembunyi?", a: "Kerja pecah dinding & penyembunyian paip ialah RM 25/kaki, dicaj mengikut panjang sebenar paip yang disembunyikan dalam dinding. Ia merangkumi kerja memecah laluan, memasang paip tembaga, wayar dan saliran secara tersembunyi, serta menampal semula dinding. Pilih pilihan ini dalam kalkulator jika mahu pemasangan yang benar-benar kemas; skop akhir disahkan di tapak." },
    ...
    zh: {
      ...
      howItWorks: [
        ...
        "添加可选项目：小型PVC线槽（电线，每英尺RM 6）或大型PVC线槽（铜管+电线+保温层，每英尺RM 12）、室外支架（标准RM 45或重型RM 70）、冷气开关/插座（RM 100）、打墙与隐藏式走管工程（每英尺RM 25）以及隐藏式安装用的排水泵。",
        "计算器自动套用即时预约折扣 — 5+台享5%折扣，10台以上享10%折扣 — 并显示完整的逐项明细。",
      ...
      factors: [
        ...
        { title: "打墙与隐藏式走管", desc: "想让铜管与电线埋入墙内而不是走明装线槽？打墙与隐藏式走管工程为每英尺RM 25，包含开槽打墙、埋设隐藏管线以及修补墙面。按实际隐藏走管长度收费。" },
        { title: "多台折扣", desc: "安装5+台享5%折扣；10台以上享10%折扣。折扣适用于整个安装配套。" },
      ],
      faqs: [
        { q: "马来西亚冷气安装费用是多少？", a: "挂壁式安装1.0–1.5匹从RM 199起，包含7英尺铜管、电线、排水管、真空泵调试和1个月工艺保修。天花板卡式从RM 290起，窗式从RM 199起。2.0匹RM 249，2.5匹RM 279，3.0匹RM 329，4.0匹RM 399，5.0匹RM 449。" },
        ...
        { q: "安装多台冷气有折扣吗？", a: "有 — KL Renovator为多台安装提供即时预约折扣：5+台享5%折扣，10台以上享10%折扣。计算器和最终报价都会自动套用。" },
        { q: "RM 199安装配套包含什么？", a: "RM 199配套（1.0–1.5匹挂壁式）包含7英尺铜管、7英尺电线、7英尺排水管、真空泵调试、全部安装人工和1个月书面工艺保修。超出7英尺的部分或额外项目（如PVC线槽、冷气开关或水泵）按已公布费率另行收费。" },
        { q: "打墙隐藏式走管的费用是多少？", a: "打墙与隐藏式走管工程为每英尺RM 25，按埋入墙内的实际走管长度收费，包含开槽打墙、埋设铜管、电线与排水管以及墙面修补。若希望安装完全隐藏，可在计算器中选择此项目取代PVC线槽；最终施工范围以现场确认为准。" },
  ...
  service: {
    en: {
      ...
      howItWorks: [
        ...
        "The tool matches your answers against common HVAC failure patterns and recommends the correct service: basic servicing (from RM 99), chemical wash (from RM 120), chemical overhaul (Wall-Mounted Aircon only, from RM 420), gas top-up (from RM 2.50/PSI), repair (diagnostic RM 88, waived with repair).",
      ...
      factors: [
        ...
        { title: "Chemical Overhaul (Wall-Mounted Aircon only) — from RM 420", desc: "Full dismantle and deep clean of the wall-mounted indoor unit. Right for water leaking, ice formation, severe blockage — the permanent fix for drain problems. Ceiling cassette, ducted, floor-standing, portable, window and other non-wall-mounted aircon types require a separate on-site quote." },
      ...
      faqs: [
        ...
        { q: "How much does it cost to service an aircond in KL & Selangor?", a: "Basic service from RM 99, pressure chemical wash from RM 120 (1.0–1.5 HP wall-mounted), chemical overhaul from RM 420, gas top-up from RM 2.50/PSI (R22) or RM 3.00/PSI (R410A/R32). Ceiling cassette and commercial units are priced separately. Every price is confirmed before work begins." },
    ...
    ms: {
      ...
      howItWorks: [
        ...
        "Alat memadankan jawapan anda dengan corak kegagalan HVAC biasa dan mencadangkan servis yang betul: servis asas (dari RM 99), cuci kimia (dari RM 120), overhaul kimia (Unit Dinding Sahaja, dari RM 420), tambah gas (dari RM 2.50/PSI), pembaikan (diagnostik RM 88, dikecualikan jika dibaiki).",
      ...
      factors: [
        ...
        { title: "Overhaul Kimia (Unit Dinding Sahaja) — dari RM 420", desc: "Pembongkaran penuh dan cucian menyeluruh unit dalaman dinding. Sesuai untuk bocor air, pembentukan ais, sekatan teruk — penyelesaian kekal untuk masalah saliran. Ceiling cassette, ducted, floor-standing, portable, window dan jenis aircond bukan-dinding yang lain memerlukan sebut harga berasingan di tapak." },
      ...
      faqs: [
        { q: "Macam mana saya tahu aircond saya perlu cuci kimia atau overhaul kimia?", a: "Cuci kimia (RM 120+) membersihkan gegelung di tempat — sesuai untuk penyejukan lemah, bau dan aliran udara perlahan. Overhaul kimia (Unit Dinding Sahaja, dari RM 420) membongkar sepenuhnya unit dalaman dinding — sesuai apabila bocor air, ais terbentuk, atau unit tidak dicuci mendalam 2+ tahun. Peraturan asas: cuci untuk prestasi, overhaul untuk bocor dan ais. Jenis aircond lain memerlukan sebut harga berasingan di tapak." },
        ...
        { q: "Berapakah kos servis aircond di KL & Selangor?", a: "Servis asas dari RM 99, cuci kimia tekanan dari RM 120 (1.0–1.5 HP dinding), overhaul kimia dari RM 420 (Unit Dinding Sahaja — 1.0–1.5 HP), tambah gas dari RM 2.50/PSI (R22) atau RM 3.00/PSI (R410A/R32). Ceiling cassette dan unit komersial dicaj berasingan. Setiap harga disahkan sebelum kerja bermula." },
    ...
    zh: {
      ...
      howItWorks: [
        ...
        "工具将您的答案与常见HVAC故障模式匹配，并推荐正确的服务：基本保养（从RM 99起）、化学清洗（从RM 120起）、化学大修（仅限挂壁式，起价RM 420）、加气（每PSI RM 2.50起）、维修（检测费RM 88，同次维修可免）。",
      ...
      factors: [
        ...
        { title: "化学大修（仅限挂壁式冷气）— 起价 RM 420", desc: "完全拆机深度清洗挂壁式室内机。适合漏水、结冰、严重堵塞 — 排水问题的永久解决方案。天花板卡式、风管机、落地式、移动式、窗式及其他非挂壁式冷气类型需另行现场报价。" },
      ...
      faqs: [
        { q: "怎么知道我的冷气需要化学清洗还是化学大修？", a: "化学清洗（RM 120起）在墙上直接清洗盘管 — 适合制冷变弱、异味、风量慢。化学大修（仅限挂壁式冷气，起价RM 420）完全拆下挂壁式室内机深度清洁 — 适合漏水、结冰或2年以上未深度清洗的机器。基本原则：性能问题用清洗，漏水结冰用大修。其他冷气类型需另行现场报价。" },
        ...
        { q: "在吉隆坡和雪兰莪保养冷气要多少钱？", a: "基本保养从RM 99起，压力化学清洗从RM 120起（1.0–1.5匹挂壁式），化学大修起价RM 420（仅限挂壁式冷气 — 1.0–1.5匹），加气每PSI RM 2.50（R22）或RM 3.00（R410A/R32）。天花板卡式和商用机单独计价。每项价格在动工前确认。" },
  ...
  savings: {
    ...
    ms: {
      ...
      faqs: [
        ...
        { q: "Bolehkah KL Renovator memasang inverter yang saya beli?", a: "Ya — KL Renovator memasang semua 20 jenama utama, inverter dan bukan inverter, dinding, ceiling cassette dan tingkap. Pemasangan bermula dari RM 199 (1.0–1.5 HP dinding) termasuk 7 kaki paip tembaga, wayar dan paip saliran, commissioning pam vakum dan waranti mutu kerja 1 bulan." },
      ],
    ...
    zh: {
      ...
      faqs: [
        ...
        { q: "KL Renovator能安装我买的变频冷气吗？", a: "可以 — KL Renovator安装全部20个主要品牌，变频和非变频，挂壁式、天花板卡式和窗式。安装从RM 199起（1.0–1.5匹挂壁式），包含7英尺铜管、电线和排水管、真空泵调试和1个月工艺保修。" },
      ],
