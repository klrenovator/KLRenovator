  ...
  installation: {
    ...
    ms: {
      ...
      howItWorks: [
        ...
        "Tambah item pilihan: casing PVC (RM 6–12/kaki), pendakap luar (standard RM 45 atau heavy duty RM 70), suis / plug point aircond (RM 100) dan pam air untuk pemasangan tersembunyi.",
      ...
      factors: [
        ...
        { title: "Panjang wayar elektrik", desc: "7 kaki percuma. Wayar tambahan RM 9/kaki (1.0–1.5 HP), RM 13/kaki (2.0–2.5 HP) dan RM 17/kaki (3.0–4.0 HP)." },
        { title: "Paip saliran & casing PVC", desc: "7 kaki paip saliran percuma; lebihan dianggarkan RM 5/kaki dan disahkan di tapak. Casing PVC untuk paip/wayar terdedah RM 6–12/kaki." },
      ...
      faqs: [
        ...
        { q: "Berapakah kos wayar elektrik aircond sekaki?", a: "7 kaki pertama wayar elektrik adalah percuma. Wayar tambahan RM 9/kaki untuk 1.0–1.5 HP, RM 13/kaki untuk 2.0–2.5 HP dan RM 17/kaki untuk unit 3.0–4.0 HP." },
    ...
    zh: {
      ...
      howItWorks: [
        ...
        "添加可选项目：PVC线槽（每英尺RM 6–12）、室外支架（标准RM 45或重型RM 70）、冷气开关/插座（RM 100）以及隐藏式安装用的排水泵。",
      ...
      factors: [
        ...
        { title: "排水管与PVC线槽", desc: "7英尺排水管免费；超出部分按每英尺RM 5估算并现场确认。外露管线用的PVC线槽每英尺RM 6–12。" },
