...
const EN_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "What does the RM 199 base installation include?", a: "The RM 199 base package includes: site survey, 7ft correctly-sized Type L copper pipe, Armaflex insulation, electrical wiring through conduit, PVC drainage, bracket with vibration pads, mandatory two-stage vacuum evacuation (min 15 min), nitrogen pressure leak test, full commissioning, and written job card with 1-month workmanship warranty.", source: "/aircond-installation-kl" },
  ...
  { category: "servicing", q: "My aircond is running but not cold. What's wrong?", a: "The most common causes are low refrigerant gas, a dirty evaporator coil, or a faulty capacitor. Our technicians diagnose the exact issue and quote you before any repair starts. Diagnostic fee is RM 88 (waived if repair is done on the same visit).", source: "/services/repair" },
  ...
  // ─── PRICING (8 questions) ──────────────────────────────────────────────────
  { category: "pricing", q: "Are there any hidden charges?", a: "No hidden charges at all. We provide a full quote before starting any work. Extra materials (copper pipe beyond 7ft, brackets, casing) are quoted and approved by you on-site before installation or repair proceeds.", source: "/installation-price-malaysia" },
  ...
  { category: "pricing", q: "Do you offer volume discounts?", a: "Yes! 4–10 units: 5% OFF Instant Booking Discount. 10+ units: 10% OFF Instant Booking Discount. Discounts apply to labour charges. WhatsApp us to confirm your discounted quote.", source: "/installation-price-malaysia" },
  ...
  { category: "pricing", q: "What is included in the installation price vs what costs extra?", a: "Included in base price: 7ft copper pipe, wiring, PVC drain, standard bracket, vacuum, leak test, commissioning. Extras (quoted on-site if needed): additional copper pipe per foot, heavy-duty bracket, casing/trunking, drilling through reinforced concrete, electrical MCB installation, condensate pump.", source: "/installation-price-malaysia" },
...
const MS_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "Apa yang termasuk dalam pakej pemasangan asas RM 199?", a: "Pakej asas RM 199 termasuk: tinjauan tapak, 7 kaki paip tembaga Jenis L bersaiz betul, penebat Armaflex, pendawaian elektrik melalui konduit, saliran PVC, pendakap dengan pad getaran, evakuasi vakum dua peringkat wajib (min 15 min), ujian kebocoran tekanan nitrogen, pentauliahan penuh, dan kad kerja bertulis dengan waranti kerja 1 bulan.", source: "/aircond-installation-kl" },
  ...
  { category: "installation", q: "Penebat apa yang anda gunakan pada paip tembaga?", a: "Kami menggunakan penebat jenama Armaflex — 9mm standard untuk saluran cecair dan 13mm untuk saluran gas. Untuk ceiling cassette dan laluan paip lebih panjang, kami menggunakan ketebalan 19mm.", source: "/aircond-installation-kl" },
  ...
  { category: "installation", q: "Adakah anda memasang untuk rumah baharu?", a: "Ya, pemasangan rumah baharu adalah salah satu perkhidmatan teras kami. Kami menawarkan pakej seluruh rumah dengan diskaun volum — 4–10 unit diskaun 5% OFF Instant Booking Discount, 10+ unit diskaun 10% OFF Instant Booking Discount.", source: "/new-home-aircond-installation" },
  ...
  { category: "pricing", q: "Adakah diskaun volum?", a: "Ya! 4–10 unit: 5% OFF Instant Booking Discount. 10+ unit: 10% OFF Instant Booking Discount. Diskaun untuk caj buruh.", source: "/installation-price-malaysia" },
  ...
  { category: "pricing", q: "Apa yang termasuk vs apa yang kos tambahan?", a: "Termasuk: 7 kaki paip tembaga, pendawaian, saliran PVC, pendakap standard, vakum, ujian kebocoran, pentauliahan. Tambahan: paip tembaga lebih, pendakap berat, casing, penggerudian konkrit, MCB, pam kondensat.", source: "/installation-price-malaysia" },
...
const ZH_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "RM 199 基础安装包含什么？", a: "RM 199 基础套餐包括：现场勘查、7 英尺正确尺寸的 L 型铜管、Armaflex 保温棉、穿管电线、PVC 排水管、带减震垫支架、强制两级真空抽气（至少 15 分钟）、氮气检漏、完整调试和附 1 个月工艺保修的书面工单。", source: "/aircond-installation-kl" },
  ...
  { category: "installation", q: "铜管上使用什么保温材料？", a: "我们使用 Armaflex 品牌闭孔保温棉——液管标准 9mm，气管 13mm。天花板卡式机和较长管路使用 19mm 厚度。", source: "/aircond-installation-kl" },
  ...
  { category: "installation", q: "是否为新房安装？", a: "是的，新房安装是我们的核心服务之一。我们提供全屋套餐和批量折扣——4–10 台享 5% OFF Instant Booking Discount（5% 即时预订折扣），10 台以上享 10% OFF Instant Booking Discount（10% 即时预订折扣）。", source: "/new-home-aircond-installation" },
  ...
  { category: "pricing", q: "有多台折扣吗？", a: "有！4–10 台享 5% OFF Instant Booking Discount（5% 即时预订折扣），10 台以上享 10% OFF Instant Booking Discount（10% 即时预订折扣）。折扣适用于人工费。", source: "/installation-price-malaysia" },
  { category: "pricing", q: "基本保养多少钱？", a: "基本保养标准壁挂式 1.0–2.5 HP 每台起价 RM 99。", source: "/aircond-service-price-malaysia" },
  { category: "pricing", q: "基础价包含什么？额外费用呢？", a: "包含：7 英尺铜管、电线、PVC 排水、标准支架、真空、检漏、调试。额外：超长铜管、重型支架、线槽、混凝土钻孔、MCB、冷凝水泵。", source: "/installation-price-malaysia" },
