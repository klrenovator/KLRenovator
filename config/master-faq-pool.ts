...
const EN_FAQS: MasterFaqItem[] = [
  ...
  { category: "pricing", q: "Do you offer volume discounts?", a: "Yes! 2–3 units: 5% off. 4–8 units: 10% off. 8+ units: 15% off. Discounts apply to labour charges. WhatsApp us to confirm your discounted quote.", source: "/installation-price-malaysia" },
...
const MS_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "Adakah anda memasang untuk rumah baharu?", a: "Ya, pemasangan rumah baharu adalah salah satu perkhidmatan teras kami. Kami menawarkan pakej seluruh rumah dengan diskaun volum — 2–3 unit diskaun 5%, 4–8 unit diskaun 10%, 8+ unit diskaun 15%.", source: "/new-home-aircond-installation" },
  ...
  { category: "pricing", q: "Adakah diskaun volum?", a: "Ya! 2–3 unit: 5%. 4–8 unit: 10%. 8+ unit: 15%. Diskaun untuk caj buruh.", source: "/installation-price-malaysia" },
...
const ZH_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "是否为新房安装？", a: "是的，新房安装是我们的核心服务之一。我们提供全屋套餐和批量折扣——2–3 台 95 折，4–8 台 9 折，8 台以上 85 折。", source: "/new-home-aircond-installation" },
  ...
  { category: "pricing", q: "有多台折扣吗？", a: "有！2–3 台 95 折，4–8 台 9 折，8 台以上 85 折。折扣适用于人工费。", source: "/installation-price-malaysia" },
