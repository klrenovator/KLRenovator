...
const EN_FAQS: MasterFaqItem[] = [
  ...
  { category: "servicing", q: "What is the difference between chemical wash and chemical overhaul?", a: "A chemical wash (from RM 120) cleans the unit while it stays mounted on the wall — great for regular maintenance. A chemical overhaul (Wall-Mounted Aircon only, from RM 420) fully dismantles the unit for a deep clean of every internal component — recommended for water leaking, ice formation, or units not serviced in 3+ years.", source: "/services/chemical-wash" },
  ...
  { category: "overhaul", q: "How much does a chemical overhaul cost?", a: "Chemical overhaul pricing is published exclusively for Wall-Mounted Aircon units. Chemical overhaul starts from RM 420 for a standard wall-mounted 1.0–1.5 HP unit, RM 490 for 2.0–2.5 HP, and RM 560 for 3.0–3.5 HP. The process takes 2–2.5 hours and includes full dismantling, deep soak cleaning, reassembly, gas pressure check, and commissioning. Ceiling cassette, ducted, floor-standing, portable, window and any other non-wall-mounted aircon types require a separate on-site assessment and quotation.", source: "/services/chemical-overhaul" },
  ...
  { category: "pricing", q: "Can I pay by credit card or bank transfer?", a: "We accept cash, bank transfer (DuitNow), and e-wallet payments. Credit card payments can be arranged for larger jobs. Payment is collected upon completion of work after you verify everything is working.", source: "/contact" },
...
const MS_FAQS: MasterFaqItem[] = [
  ...
  { category: "servicing", q: "Apa beza cuci kimia dan overhaul kimia?", a: "Cuci kimia (dari RM 120) membersihkan unit di tempat ia terpasang. Overhaul kimia (Unit Dinding Sahaja, dari RM 420) menanggalkan unit sepenuhnya untuk pembersihan mendalam.", source: "/services/chemical-wash" },
  ...
  { category: "overhaul", q: "Berapa kos overhaul kimia?", a: "Harga overhaul kimia diterbitkan secara eksklusif untuk unit dinding sahaja. Overhaul kimia bermula dari RM 420 untuk unit dinding 1.0–1.5 HP standard, RM 490 untuk 2.0–2.5 HP, dan RM 560 untuk 3.0–3.5 HP. Jenis aircond lain (ceiling cassette, ducted, floor-standing, portable, window) memerlukan sebut harga berasingan di tapak. Proses mengambil 2–2.5 jam.", source: "/services/chemical-overhaul" },
...
const ZH_FAQS: MasterFaqItem[] = [
  ...
  { category: "overhaul", q: "化学大修费用多少？", a: "化学大修价格仅针对壁挂式冷气公布：1.0–1.5 HP 起价 RM 420，2.0–2.5 HP 起价 RM 490，3.0–3.5 HP 起价 RM 560。其他类型（天花板卡式、风管机、落地式、移动式、窗式）需另行现场报价。过程需 2–2.5 小时。", source: "/services/chemical-overhaul" },
