...
const ZH_FAQS: MasterFaqItem[] = [
  ...
  { category: "installation", q: "RM 199 基础安装包含什么？", a: "RM 199 基础套餐包括：现场勘查、7 英尺正确尺寸的 L 型铜管、Armaflex 保温棉、穿管电线、PVC 排水管、带减震垫支架、强制两级真空抽气（至少 15 分钟）、真空泵调试（500微米）、完整调试和附 1 个月工艺保修的书面工单。", source: "/aircond-installation-kl" },
