...
const PROFILE_COPY: Record<KampungMatrixLocale, Record<ProfileKey, MatrixCopy>> = {
  ...
  ms: {
    ...
    landed: {
      ...
      access: "Kami rancang akses pagar, laluan paip tembaga dari tingkat atas ke bawah, bracket dinding dan posisi kompressor luar sebelum sebut harga tambahan.",
