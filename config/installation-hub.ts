...
> = {
  en: {
    ...
    areasSub: "We install across 40 areas in Kuala Lumpur and Selangor.",
  ...
  ms: {
    ...
    areasSub: "Kami memasang di 40 kawasan di Kuala Lumpur dan Selangor.",
  ...
  zh: {
    ...
    areasTitle: "就近安装服务",
    areasSub: "我们的安装服务覆盖吉隆坡及雪兰莪 40 个地区。",
    areasCta: "查看所有服务地区",
    brandsTitle: "按品牌安装",
