...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "chemical-overhaul": {
    ...
    priceTable: [
      ...
      { label: "Wall-Mounted · 4.0 – 5.0 HP", price: "RM 420" },
  ...
  "gas-topup": {
    ...
    priceTable: [
      { label: "R22 Gas · 1.0 – 1.5 HP", price: "RM 120" },
      { label: "R22 Gas · 2.0 – 2.5 HP", price: "RM 150" },
      { label: "R410A Gas · 1.0 – 1.5 HP", price: "RM 150" },
      { label: "R410A Gas · 2.0 – 2.5 HP", price: "RM 180" },
      { label: "R32 Gas · 1.0 – 1.5 HP", price: "RM 180" },
      { label: "R32 Gas · 2.0 – 2.5 HP", price: "RM 220" },
      { label: "R32 Gas · 3.0 HP", price: "RM 260" },
    ],
  },
  ...
  "installation": {
    ...
    priceTable: [
      { label: "Wall-Mounted Installation (standard)", price: "RM 199" },
      { label: "Wall-Mounted Installation (2.0–2.5 HP)", price: "RM 230" },
      { label: "Ceiling Cassette Installation", price: "RM 290" },
  ...
  "basic-servicing": {
    ...
    priceTable: [
      ...
      { label: "Wall-Mounted · 3.0 HP", price: "RM 140" },
      { label: "Wall-Mounted · 4.0 – 5.0 HP", price: "RM 160" },
      { label: "Ceiling Cassette · 1.0 – 2.5 HP", price: "RM 120" },
      { label: "Window Unit · 1.0 – 2.0 HP", price: "RM 99" },
    ],
  },
  ...
  "ceiling-cassette": {
    ...
    priceTable: [
      ...
      { label: "Basic Service · 2.0 – 3.0 HP", price: "RM 180" },
      ...
      { label: "Chemical Overhaul · 4.0 – 5.0 HP", price: "RM 480" },
    ],
  },
