...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "installation": {
    ...
    tagline: "Professional AC setup with clean routing — all brands, all HP sizes.",
    description:
      "We install all types of split-unit airconds for residential and commercial spaces. Our technicians handle complete copper pipe routing, wiring, drainage, and outdoor bracket mounting. Old unit dismantling is also available before new installation.",
    startPrice: "RM 199",
    heroImage:
      "https://images.unsplash.com/photo-1628592102751-ba83b0314276?auto=format&fit=crop&w=1600&q=80",
    highlights: [
      "All residential & commercial brands",
      "Clean concealed cable & pipe routing",
    ...
    process: [
      ...
      { step: "Bracket & pipe", desc: "Outdoor bracket fixed; copper & drain line routed." },
      { step: "Install indoor unit", desc: "Indoor unit mounted, all connections secured." },
      { step: "Commission & test", desc: "System charged, tested, and handed over." },
    ],
    faqs: [
      { q: "Is the copper pipe included in the price?", a: "Yes — standard 7ft copper pipe is included. Additional pipe length is charged at RM 18/ft." },
      { q: "Can you dismantle my old unit before installing new one?", a: "Yes. Dismantling of an existing unit starts from RM 90 and can be done in the same visit." },
      { q: "Do you supply the AC unit or just install?", a: "We provide installation service only. You supply the unit, or we can advise on the best brand and model for your space." },
      { q: "How long does installation take?", a: "A standard single unit installation takes 2–3 hours. Multiple units are quoted per job." },
    ],
    priceTable: [
      { label: "1.0 HP", price: "RM 199" },
      { label: "1.5 HP", price: "RM 199" },
      { label: "2.0 HP", price: "RM 249" },
      { label: "2.5 HP", price: "RM 279" },
      { label: "3.0 HP", price: "RM 329" },
      { label: "4.0 HP", price: "RM 399" },
      { label: "5.0 HP", price: "RM 449" },
      { label: "Additional copper pipe (per foot)", price: "RM 18" },
  ...
  "repair": {
    ...
    tagline: "Fast diagnosis and same-day repair — quote before we start.",
    description:
      "Our technicians diagnose the root cause of your aircond problem and repair it on the spot. Common repairs include capacitor replacement, fan motor, PCB board, sensor coil, and copper wiring. We quote before starting — no surprise bills.",
    startPrice: "RM 88",
    heroImage:
      "https://images.unsplash.com/photo-1631545308456-c3e32f5f1abe?auto=format&fit=crop&w=1600&q=80",
    highlights: [
      "Diagnostic fee RM 88 (waived if repair done)",
      "OEM & compatible parts used",
      "Quote given before any repair",
      "PCB board, capacitor, fan motor repairs",
      "Copper wiring & sensor replacement",
      "Same-day completion for most repairs",
    ],
    process: [
      { step: "Diagnose", desc: "Multi-point electrical and mechanical check to find root cause." },
      { step: "Quote", desc: "We explain the problem and quote parts + labour before starting." },
      { step: "Repair", desc: "Parts replaced with OEM or compatible components." },
      { step: "Test", desc: "Full cooling and electrical test after repair." },
    ],
    faqs: [
    ...
    priceTable: [
      ...
      { label: "Sensor / thermistor replacement", price: "RM 120 – 200" },
      { label: "Copper pipe repair / replacement", price: "From RM 150" },
