...
export const servicesData: Record<string, ServiceDetail> = {
  ...
  "chemical-wash": {
    ...
    tagline: "High-pressure chemical deep-clean while the unit stays mounted — kills mould, dissolves biofilm, restores cooling. From RM 120.",
    description:
      "Your aircond has been running 8 hours a day for 12 months. The filter catches dust — but what about the evaporator coil and blower wheel? Those fins and blades are now coated in a thick, damp layer of mould, biofilm, dust mites, and bacterial sludge. That is why the air smells musty. That is why the cooling is weak even though the thermostat says 16\u00b0C. A pressure chemical wash is the fix: our technician sprays a food-safe alkaline chemical solution at 80\u2013120 PSI directly onto the coil and blower wheel while the unit remains mounted on your wall. The chemical dissolves the biofilm within minutes. A high-pressure water rinse then flushes every dissolved contaminant out through the drain pipe. The result: cooling output restored to near-new levels, musty smell eliminated, and airflow strong again \u2014 all in about 60\u201375 minutes without dismantling the unit. RM 120 for 1.0\u20131.5 HP wall-mounted. Recommended every 12 months, or sooner if you live near a main road, construction site, or in a ground-floor unit.",
    startPrice: "RM 120",
    ...
    faqs: [
      ...
      {
        q: "Chemical wash vs chemical overhaul \u2014 which do I need?",
        a: "Chemical wash (this service): unit stays mounted, chemical sprayed at pressure \u2014 good for 90% of units that need more than basic but are not yet leaking or icing. Chemical overhaul (RM 220): full dismantle, every component removed and soaked individually \u2014 necessary when the unit is actively leaking water, has visible ice on the coil, blows extremely foul odour, or has not been opened in 3+ years. Not sure? WhatsApp us a photo of your unit and describe the symptoms \u2014 we will tell you honestly which level you need.",
      },
      {
        q: "Will chemical wash stop water leaking from my indoor unit?",
        a: "It often stops it \u2014 if the cause is a biofilm-clogged drain pipe. During the chemical wash, the high-pressure flush clears the drain path as the chemical dissolves the sludge. If the leaking continues after the wash, the problem is deeper: the drain pan itself is clogged or cracked, which requires a chemical overhaul (full dismantle) to access. We will check during the wash and advise you honestly.",
      },
      {
    ...
    faqsBM: [
      ...
      {
        q: "Cuci kimia vs overhaul kimia \u2014 yang mana saya perlukan?",
        a: "Cuci kimia (perkhidmatan ini): unit kekal dipasang, kimia disembur pada tekanan \u2014 sesuai untuk 90% unit yang memerlukan lebih daripada servis asas tetapi belum bocor atau berais. Overhaul kimia (RM 220): pembongkaran penuh, setiap komponen dikeluarkan dan direndam secara individu \u2014 perlu apabila unit secara aktif bocor air, mempunyai ais kelihatan pada gegelung, mengeluarkan bau yang sangat busuk, atau tidak pernah dibuka dalam 3+ tahun. Tidak pasti? WhatsApp kami foto unit anda dan jelaskan simptomnya.",
      },
      {
        q: "Adakah cuci kimia akan menghentikan kebocoran air dari unit dalaman saya?",
        a: "Selalunya ia menghentikannya \u2014 jika puncanya adalah paip longkang tersumbat biofilm. Semasa cuci kimia, bilasan tekanan tinggi membersihkan laluan longkang semasa kimia melarutkan enap cemar. Jika kebocoran berterusan selepas cucian, masalahnya lebih dalam: dulang longkang itu sendiri tersumbat atau retak, yang memerlukan overhaul kimia (pembongkaran penuh) untuk diakses. Kami akan memeriksa semasa cucian dan menasihatkan anda dengan jujur.",
      },
    ],
    faqsZH: [
      {
      ...
      {
        q: "化学清洗vs化学大修\u2014\u2014我需要哪一个？",
        a: "化学清洗（本服务）：机器保持挂墙状态，化学液高压喷涂\u2014\u2014适用于90%需要超越基本保养但尚未漏水或结冰的机器。化学大修（RM 220）：完全拆卸，每个零件单独取出浸泡\u2014\u2014适用于主动漏水、盘管可见结冰、散发极臭气味或3年以上未打开过的机器。不确定？WhatsApp我们机器照片并描述症状\u2014\u2014我们会诚实告诉您需要哪个级别。",
      },
      {
        q: "化学清洗能阻止室内机漏水吗？",
        a: "通常可以\u2014\u2014如果原因是排水管被生物膜堵塞。化学清洗过程中，高压冲洗在化学溶解淤泥的同时清理排水通道。如果清洗后仍漏水，说明问题更深：排水盘本身堵塞或破裂，需要化学大修（完全拆卸）才能处理。我们会在清洗过程中检查并诚实告知。",
      },
    ],
    priceTable: [
