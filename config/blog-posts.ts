...
export const allPosts: BlogPost[] = [
  // ─── NEW 2026 Articles (Fresh Content) ──────────────────────
  {
    slug: "aircon-service-batu-caves-selayang-2026",
    title: "Aircon Service in Batu Caves & Selayang — What to Expect in 2026",
    excerpt:
      "Looking for reliable aircond servicing in Batu Caves or Selayang? Here's what residents should know — pricing, common issues, and why regular servicing matters in this area.",
    ...
    content: `
      ...
      <p>For units running 6–8 hours per day (typical for bedrooms and living halls in this area), we recommend:</p>
      <ul>
      ...
      <h2>How to Book</h2>
      <p>WhatsApp <strong>+60 18-298 3573</strong> with your location (Batu Caves, Selayang, Kepong, or surrounding area), unit type, and issue. We'll confirm a slot within 30 minutes.</p>
    `,
  },
  {
    ...
    excerpt:
      "What does a chemical wash actually cost in Malaysia in 2026? Here's a full price breakdown by unit type and HP — including what's included and what's not.",
    ...
    content: `
      ...
      <p>WhatsApp <strong>+60 18-298 3573</strong> for a firm quote based on your unit type and location across KL & Selangor.</p>
    `,
  },
  {
    ...
    excerpt:
      "A chemical wash won't fix everything. Here are 5 clear signs that your aircond unit needs a full chemical overhaul — and what happens if you keep delaying it.",
    ...
    content: `
      ...
      <p>Ice on the evaporator coil means severely restricted airflow — usually from a heavily blocked coil that a chemical wash cannot fully clean while the unit is still mounted. An overhaul dismantles the coil for a proper soak and rinse.</p>

      <h2>Sign 3: Foul Smell Returns Within 2 Months</h2>
      <p>If you had a chemical wash and the musty or sour smell returns quickly, mould has grown deep inside the blower wheel, drain pan, or hidden corners — areas a mounted wash cannot reach.</p>
      ...
      <h2>What to Do</h2>
      <p>WhatsApp KL Renovator at <strong>+60 18-298 3573</strong>. Send a photo or video of the issue and we'll advise honestly whether you need a wash or overhaul — no upselling.</p>
      <p>Chemical overhaul starts from <strong>RM 220</strong> for a wall-mounted 1.0–1.5 HP unit. All brands covered. Same-day available across KL & Selangor.</p>
    `,
  },
  ...
  },
  {
    ...
    content: `
      ...
      <p>A blocked filter restricts airflow across the coil. Solution: Clean or replace the filter. This is something you can do yourself every month.</p>
      ...
      <p>A 1.0 HP unit in a 600 sq ft living room will struggle. If the unit has always been weak, the HP may simply be insufficient for the space.</p>

      <h2>What to Do</h2>
      <p>WhatsApp KL Renovator at <strong>+60 18-298 3573</strong> with your unit brand, HP, and a description of the problem. We'll diagnose and quote you before starting any work. Diagnostic fee RM 88 (waived if repair is done).</p>
    `,
  },
  {
  ...
  },
  {
    ...
    content: `
      ...
      <h2>R22 (Freon)</h2>
      <p>The oldest gas type. Found in units made before 2015. R22 is being phased out globally due to its high ozone depletion potential. If your unit uses R22, replacement with a newer unit is worth considering.</p>
      <ul>
        <li>Units: Pre-2015 models</li>
        <li>Cost: RM 80–160 per top-up (increasingly expensive due to phase-out)</li>
      </ul>

      <h2>R410A</h2>
      <p>The standard gas for units made between 2010–2020. No ozone depletion but higher global warming potential than R32. Still widely used in Malaysia.</p>
      <ul>
        <li>Units: 2010–2020 Daikin, Panasonic, Mitsubishi, LG, Samsung</li>
        <li>Cost: RM 100–180 per top-up</li>
      </ul>

      <h2>R32</h2>
      <p>The current standard for new inverter units. Lower global warming potential, better energy efficiency. Most new Daikin, Panasonic, and Mitsubishi units use R32.</p>
      <ul>
        <li>Units: 2018 onwards, especially inverter models</li>
        <li>Cost: RM 130–200 per top-up</li>
      </ul>

      <h2>How to Check Which Gas Your Unit Uses</h2>
      <p>Look at the sticker on your outdoor unit — it clearly states the refrigerant type. Alternatively, WhatsApp us a photo of the sticker at <strong>+60 18-298 3573</strong> and we'll identify it for you.</p>

      <p>KL Renovator performs precision gas top-up for all three gas types across KL & Selangor. Leak check included in every top-up service.</p>
    `,
  },
  {
    ...
    content: `
      ...
      <p>Water leaking from your indoor unit is the most common aircond complaint in Malaysia — especially during rainy season and in high-humidity areas. Here are the main causes and what to do about each.</p>

      <h2>Cause 1: Blocked Drain Pipe</h2>
      <p>The most common cause. Algae, mould, and debris clog the drain pipe, causing water to back up and overflow from the drain pan. Solution: Service with drain pipe flush — usually fixed during a basic service or chemical wash.</p>

      <h2>Cause 2: Dirty Evaporator Coil</h2>
      <p>When the coil is coated with dirt, it can't absorb moisture properly. Excess condensation forms and drips. Solution: Chemical wash or overhaul.</p>

      <h2>Cause 3: Ice on the Coil Melting</h2>
      <p>If the coil freezes (due to low gas or severe blockage) and then melts, a large amount of water drips suddenly. You may notice a temporary flood of water. Solution: Check gas levels and clean the coil.</p>

      <h2>Cause 4: Damaged or Cracked Drain Pan</h2>
      <p>Over time, the plastic drain pan can crack. Water then leaks directly from the pan instead of through the pipe. Solution: Drain pan replacement during an overhaul.</p>

      <h2>What to Do Right Now</h2>
      <ul>
        <li>Place a bucket or towel below the unit</li>
        <li>Turn off the aircond if leaking heavily</li>
        <li>Don't try to unblock the drain pipe yourself with sharp objects</li>
        <li>WhatsApp KL Renovator at <strong>+60 18-298 3573</strong> — we'll advise whether a basic service or overhaul is needed</li>
      </ul>
    `,
  },
  {
    ...
    content: `
      ...
      <p>Daikin is consistently the most reliable brand we service. Japanese engineering, excellent energy efficiency on inverter models, and spare parts are widely available across Malaysia.</p>
      <ul>
        <li>Best for: Reliability, long lifespan</li>
        <li>Gas type: R32 (new models)</li>
        <li>Price range: RM 1,200 – 3,500</li>
      </ul>

      <h2>Panasonic — Best Value</h2>
      <p>Panasonic units offer excellent value for money. The nanoe-X air purification feature is a genuine benefit for families with allergies. Very common in Malaysian condos and terrace houses.</p>
      <ul>
        <li>Best for: Value, air quality features</li>
        <li>Gas type: R32 (new models)</li>
        <li>Price range: RM 1,100 – 3,000</li>
      </ul>

      <h2>Mitsubishi Electric — Best for Heavy Use</h2>
      <p>Mitsubishi Electric units are built for continuous heavy-duty operation. Often the first choice for commercial spaces and large living areas.</p>
      <ul>
        <li>Best for: Commercial use, heavy residential</li>
        <li>Gas type: R32 / R410A</li>
        <li>Price range: RM 1,400 – 4,000</li>
      </ul>

      <h2>Midea — Best Budget Option</h2>
      <p>Midea has improved significantly in recent years. Good budget option for small rooms, rental properties, and secondary bedrooms. Parts are affordable and widely available.</p>
      <ul>
        <li>Best for: Budget, rental properties</li>
        <li>Gas type: R32</li>
        <li>Price range: RM 800 – 1,800</li>
      </ul>

      <h2>Our Recommendation</h2>
      <p>For most Malaysian homes: <strong>Daikin or Panasonic</strong> inverter models. They last longer, use less electricity, and are easier to service.</p>
      <p>Need installation? KL Renovator installs all brands across KL & Selangor. WhatsApp <strong>+60 18-298 3573</strong> for a quote.</p>
    `,
  },
];
