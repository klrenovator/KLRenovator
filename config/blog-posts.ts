...
export const allPosts: BlogPost[] = [
  ...
  },
  {
    ...
    contentMS: `
      ...
      <details><summary><strong>Adakah KL Renovator berdaftar SSM?</strong></summary><p>Ya, KL Renovator adalah syarikat berdaftar SSM (Multicore Dynamics Resources). Semua juruteknik berlesen &amp; berlatiah HVAC. ${reviewCountLabel} ulasan 5 bintang di Google Maps.</p></details>
    `,
