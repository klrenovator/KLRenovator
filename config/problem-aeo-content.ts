...
> = {
  ...
  "aircond-compressor-problem": {
    directAnswerEN: "A compressor that won't start, hums without spinning, or trips the breaker repeatedly usually points to a failed start capacitor first (a RM 150-200 fix) rather than the compressor itself — KL Renovator always rules out the capacitor before recommending compressor replacement, which is a much larger cost.",
