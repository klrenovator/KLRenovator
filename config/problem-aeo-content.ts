...
> = {
  ...
  "aircond-thermostat-problems": {
    directAnswerEN: "If your aircond runs non-stop without reaching the set temperature, or shuts off too early leaving the room warm, the temperature sensor is the most common culprit — it's a relatively inexpensive part to replace once confirmed faulty.",
