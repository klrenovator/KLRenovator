...
> = {
  "1hp": {
    en: {
      ...
      ogImage: "/hero/midea-aircond-basic-servicing-petaling-jaya-17.webp",
    ...
    zh: {
      ...
      faqs: [
        { q: "吉隆坡1匹冷气安装多少钱？", a: "1匹挂壁式冷气安装从RM199起，包含7尺铜管、电线和排水管。室外支架如有需要将另行收费。1匹天花板卡式机从RM290起。超出7尺的材料会在施工前报价。" },
  ...
  "1.5hp": {
    en: {
      ...
      ogImage: "/hero/lg-aircond-basic-servicing-subang-jaya-29.webp",
    ...
    zh: {
      ...
      whyItems: whyChoose.zh,
      faqs: [
        { q: "1.5匹冷气安装多少钱？", a: "1.5匹挂壁式冷气安装从RM199起，包含7尺铜管、电线和排水管。室外支架如有需要将另行收费。1.5匹天花板卡式机从RM290起。所有额外费用均在施工前报价并确认。" },
  ...
  "2hp": {
    en: {
      ...
      ogImage: "/hero/daikin-aircond-basic-servicing-ampang-140.webp",
    ...
    zh: {
      ...
      whyItems: whyChoose.zh,
      faqs: [
        { q: "2匹冷气安装多少钱？", a: "2匹挂壁式冷气安装从RM249起，包含7尺铜管、电线和排水管。室外支架如有需要将另行收费。2匹天花板卡式机从RM350起。价格已包含更大直径铜管；室外支架另行收费。" },
  ...
  "wall-mounted": {
    en: {
      ...
      ogImage: "/hero/samsung-aircond-basic-servicing-puchong-41.webp",
  ...
  "ceiling-cassette": {
    en: {
      ...
      ogImage: "/hero/panasonic-aircond-ceiling-cassette-service-klang-68.webp",
  ...
  "window-unit": {
    en: {
      ...
      subtitle: "From RM 199 · Same-Day · Budget Cooling for Rentals & Older Homes",
      heroBadges: ["From RM 199", "Same-Day Available", "1-Month Warranty", "No Outdoor Unit Bracket"],
      ...
      pricingRows: [
        { hp: "1.0 HP", labour: "RM 199", pipe: "Self-contained", note: "" },
        { hp: "1.5 HP", labour: "RM 199", pipe: "Self-contained", note: "" },
        { hp: "2.0 HP", labour: "RM 249", pipe: "Self-contained", note: "" },
      ],
      includedTitle: "What's Included",
      includedItems: [
        "Site survey & quotation (free)",
      ...
      whyItems: whyChoose.en,
      faqs: [
        { q: "How much does window aircond installation cost?", a: "Window unit installation starts from RM 199 for 1.0–1.5 HP and RM 249 for 2.0 HP. Price includes window frame mounting, weather sealing, electrical wiring, and 1-month workmanship warranty." },
      ...
      ctaBody: "Budget cooling from RM 199. Same-day installation across KL & Selangor.",
    ...
    ms: {
      ...
      subtitle: "Dari RM 199 · Hari Sama · Penyejukan Ekonomi untuk Sewaan & Rumah Lama",
      heroBadges: ["Dari RM 199", "Hari Sama Tersedia", "Waranti 1 Bulan", "Tiada Braket Unit Luar"],
      ...
      pricingRows: [
        { hp: "1.0 HP", labour: "RM 199", pipe: "Terkandung", note: "" },
        { hp: "1.5 HP", labour: "RM 199", pipe: "Terkandung", note: "" },
        { hp: "2.0 HP", labour: "RM 249", pipe: "Terkandung", note: "" },
      ],
      includedTitle: "Apa Yang Termasuk",
      includedItems: [
        "Pemeriksaan tapak & sebut harga (percuma)",
      ...
      whyItems: whyChoose.ms,
      faqs: [
        { q: "Berapa harga pemasangan aircond tingkap?", a: "Pemasangan unit tingkap bermula RM 199 untuk 1.0–1.5 HP dan RM 249 untuk 2.0 HP. Harga termasuk pemasangan bingkai tingkap, penyegel cuaca, wayar elektrik, dan waranti kerja 1 bulan." },
      ...
      ctaBody: "Penyejukan ekonomi dari RM 199. Pemasangan hari sama di KL & Selangor.",
    ...
    zh: {
      ...
      eyebrow: "窗口式冷气安装专家",
      h1: "窗口式冷气安装 吉隆坡 & 雪兰莪",
      subtitle: "RM199起 · 当天服务 · 出租屋与旧住宅的经济制冷方案",
      heroBadges: ["RM199起", "可当天上门", "1个月保修", "无需室外机支架"],
      ...
      pricingRows: [
        { hp: "1.0 匹", labour: "RM 199", pipe: "一体机", note: "" },
        { hp: "1.5 匹", labour: "RM 199", pipe: "一体机", note: "" },
        { hp: "2.0 匹", labour: "RM 249", pipe: "一体机", note: "" },
      ],
      includedTitle: "包含项目",
      includedItems: [
        "免费现场勘察与报价",
      ...
      whyItems: whyChoose.zh,
      faqs: [
        { q: "窗口式冷气安装多少钱？", a: "窗口式冷气安装1.0–1.5匹从RM199起，2.0匹RM249。价格包含窗框安装、防水密封、电线接入和1个月工艺保修。" },
      ...
      ctaBody: "经济制冷从RM199起。吉隆坡和雪兰莪可当天安装。",
