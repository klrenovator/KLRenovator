...
export const GoogleReviews = () => {
  ...
  return (
    <section
      id="reviews"
      className="py-16 sm:py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900/50 dark:to-slate-950"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal>
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-4 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300">
              <FaGoogle className="h-3.5 w-3.5 text-brand-600" />
        ...
        {/* Reviews grid — 5 reviews: large first + 4 smaller */}
        <div className="mt-10 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
          {reviews.slice(0, 5).map((r, i) => (
            ...
            >
              <article
                className={
                  "flex h-full flex-col rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-5 sm:p-6 shadow-sm hover:shadow-lg transition-shadow " +
                  (i === 0
                    ? "border-brand-200 dark:border-brand-800 bg-gradient-to-br from-white to-brand-50/50 dark:from-slate-900 dark:to-brand-900/10"
                    : "")
                }
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-brand-500 to-brand-700 text-white text-sm font-bold">
                      {r.initials}
                    </div>
                    <div>
                ...
                <Quote className="mt-3 h-5 w-5 text-brand-400 shrink-0" />
        ...
        <Reveal>
          <div className="mt-10 flex justify-center">
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-5 py-2.5 text-sm font-semibold text-slate-800 dark:text-slate-200 hover:border-brand-500 hover:text-brand-600 transition"
            >
