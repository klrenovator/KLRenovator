...
const LAYOUT_STRINGS: Record<"en" | "ms" | "zh", {
  ...
  en: {
    ...
    linkCard1Desc: "Basic service RM 99, chemical wash RM 120, Chemical Overhaul (Wall-Mounted only) from RM 420, gas RM 2.50/PSI. Full published price list.",
  ...
  ms: {
    ...
    linkCard1Desc: "Servis asas RM 99, cuci kimia RM 120, Overhaul (Unit Dinding Sahaja) dari RM 420, gas RM 2.50/PSI. Senarai harga penuh yang diterbitkan.",
  ...
  zh: {
    ...
    linkCard1Desc: "基本保养RM 99、化学清洗RM 120、化学大修（仅限挂壁式）起价 RM 420、气体每PSI RM 2.50。完整已公布价目表。",
