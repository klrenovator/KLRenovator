...
const DATA: Record<Lang, {
  ...
  en: {
    ...
    orgDescription: "KL Renovator (Multicore Dynamics Resources) is a professional HVAC and aircond servicing company based in Mont Kiara, Kuala Lumpur, serving all of Kuala Lumpur and Selangor since 2014. Specialized in chemical wash, chemical overhaul, gas top-up, repair, and new unit installation.",
    ...
    team: [
      {
        ...
        image: "/hero/generic-aircond-gas-topup-rawang-123.webp",
      ...
      },
      {
        ...
        image: "/hero/generic-aircond-gas-topup-shah-alam-101.webp",
      ...
      },
      {
        ...
        image: "/hero/generic-aircond-gas-topup-subang-jaya-136.webp",
  ...
  ms: {
    ...
    orgDescription: "KL Renovator (Multicore Dynamics Resources) adalah syarikat servis HVAC dan aircond profesional yang berpangkalan di Mont Kiara, Kuala Lumpur, melayani seluruh Kuala Lumpur dan Selangor sejak 2014. Pakar dalam cuci kimia, overhaul kimia, tambah gas, pembaikan, dan pemasangan unit baharu.",
  ...
  zh: {
    ...
    orgDescription: "KL Renovator（Multicore Dynamics Resources）是一家总部位于吉隆坡Mont Kiara的专业 HVAC 及冷气服务公司，自 2014 年起服务整个吉隆坡及雪兰莪。专精化学清洗、化学大修、充冷媒、维修及新机安装。",
...
export function AboutPageI18n({ lang }: { lang: Lang }) {
  ...
  const organizationSchema = {
    ...
    address: {
      "@type": "PostalAddress",
      // Part 4 NAP fix: align with config/site/core.ts + GBP-facing identity.
    ...
    <>
      ...
      <section className="relative bg-white overflow-hidden border-b border-slate-100">
        <div className="absolute inset-0 opacity-10">
          <Image
            src="/hero/generic-aircond-gas-topup-kuala-lumpur-107.webp"
      ...
      <section className="py-16 sm:py-20 bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <NextLink
              href={lang === "en" ? "/gallery" : `/${lang}/gallery`}
              className="inline-flex items-center justify-center rounded-xl bg-sky-600 px-6 py-3 text-sm font-black uppercase tracking-widest text-white hover:bg-sky-700 transition"
            >
              {lang === "ms" ? "Lihat Galeri Kerja" : lang === "zh" ? "查看工程图库" : "View Project Gallery"}
            </NextLink>
          </div>
        </div>
      </section>
