...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    // NOTE: /review, /ms/review and /zh/review are deliberately OMITTED —
    // they are `robots: { index: false }` post-service "thank you / leave a
    // review" conversion pages. Listing noindex URLs in the sitemap is a
    // signal contradiction, so they are excluded here by design.
  ...
  const installationPages: MetadataRoute.Sitemap = [
    ...
    // ── Commercial service hub + Indoor Air Quality hub (issue #75) ──
    { url: `${BASE}/commercial-aircond-service`, lastModified: now, changeFrequency: "monthly", priority: 0.92, alternates: buildTrilingual({ en: "/commercial-aircond-service", ms: "/ms/servis-aircond-komersial", zh: "/zh/commercial-aircond-service" }) },
    { url: `${BASE}/ms/servis-aircond-komersial`, lastModified: now, changeFrequency: "monthly", priority: 0.88, alternates: buildTrilingual({ en: "/commercial-aircond-service", ms: "/ms/servis-aircond-komersial", zh: "/zh/commercial-aircond-service" }) },
    { url: `${BASE}/zh/commercial-aircond-service`, lastModified: now, changeFrequency: "monthly", priority: 0.86, alternates: buildTrilingual({ en: "/commercial-aircond-service", ms: "/ms/servis-aircond-komersial", zh: "/zh/commercial-aircond-service" }) },
    { url: `${BASE}/indoor-air-quality-aircond`, lastModified: now, changeFrequency: "monthly", priority: 0.90, alternates: buildTrilingual({ en: "/indoor-air-quality-aircond", ms: "/ms/kualiti-udara-dalaman-aircond", zh: "/zh/indoor-air-quality-aircond" }) },
    { url: `${BASE}/ms/kualiti-udara-dalaman-aircond`, lastModified: now, changeFrequency: "monthly", priority: 0.86, alternates: buildTrilingual({ en: "/indoor-air-quality-aircond", ms: "/ms/kualiti-udara-dalaman-aircond", zh: "/zh/indoor-air-quality-aircond" }) },
    { url: `${BASE}/zh/indoor-air-quality-aircond`, lastModified: now, changeFrequency: "monthly", priority: 0.84, alternates: buildTrilingual({ en: "/indoor-air-quality-aircond", ms: "/ms/kualiti-udara-dalaman-aircond", zh: "/zh/indoor-air-quality-aircond" }) },
