...
export const translations = {
  en: {
    ...
    hero_desc: "Professional aircond installation from RM199 — plus chemical wash, overhaul, gas top-up, repairs & servicing for all 20 brands. Same-day, transparent pricing, 1-month workmanship warranty. Rapid response teams across KL & Selangor.",
  ...
  ms: {
    ...
    hero_desc: "Pemasangan aircond profesional dari RM199 — cuci kimia, overhaul, tambah gas, pembaikan & servis untuk semua 20 jenama. Harga telus, hari sama, waranti kerja 1 bulan. Pasukan pantas merentasi KL & Selangor.",
  ...
  zh: {
    ...
    hero_desc: "专业冷气安装RM199起 — 化学清洗、大修、充气、维修与服务，覆盖全部20个品牌。透明价格，当天上门，1个月工艺保修。快速响应团队覆盖吉隆坡及雪兰莪。",
