...
export const translations = {
  en: {
    ...
    nav_book: "Book Now", nav_topbar: "Same-day Aircond Service Across KL & Selangor",
    hero_badge: "⭐ TOP RATED 4.9 / 5 ON GOOGLE MAPS REVIEWS",
    hero_h1_line1: "Expert Aircond Services", hero_h1_line2: "In KL & Selangor",
    hero_desc: "Premium residential and commercial HVAC solutions by KL Renovator. Specialist pressure chemical wash, chemical overhaul, precision troubleshooting, leak repairs, and gas balancing. Rapid response teams across Klang Valley.",
    hero_whatsapp: "Book Via WhatsApp", hero_call: "Call +60 18-298 3573",
    hero_trust1: "Same-Day Scheduled Visits", hero_trust2: "Expert Aircond Technicians", hero_trust3: "Transparent Upfront Rates",
    ...
    services_eyebrow: "Premium Aircond Solutions", services_title1: "Our Expert ", services_title2: "Aircond Services",
    services_desc: "Professional residential and commercial HVAC services across Kuala Lumpur and Selangor. Click any service to view details and pricing.",
    ...
    footer_desc: "Premium residential and commercial airconditioning across Kuala Lumpur & Selangor. Managed under Multicore Dynamic Resources.",
  ...
  ms: {
    ...
    nav_book: "Tempah Sekarang", nav_topbar: "Servis Aircond Hari Sama Seluruh KL & Selangor",
    hero_badge: "⭐ PENILAIAN TERTINGGI 4.9 / 5 DI GOOGLE MAPS",
    hero_h1_line1: "Pakar Servis Aircond", hero_h1_line2: "KL & Selangor",
    hero_desc: "Penyelesaian HVAC kediaman dan komersial premium oleh KL Renovator. Pakar cuci kimia bertekanan, overhaul kimia, penyelesaian masalah, pembaikan kebocoran, dan mengimbang gas. Pasukan tindak balas pantas seluruh Lembah Klang.",
    hero_whatsapp: "Tempah Via WhatsApp", hero_call: "Hubungi +60 18-298 3573",
    hero_trust1: "Lawatan Hari Sama", hero_trust2: "Juruteknik Aircond Pakar", hero_trust3: "Kadar Telus & Jelas",
    ...
    services_eyebrow: "Penyelesaian Aircond Premium", services_title1: "Perkhidmatan Aircond ", services_title2: "Profesional Kami",
    services_desc: "Perkhidmatan HVAC profesional merentasi Kuala Lumpur dan Selangor. Klik mana-mana perkhidmatan untuk lihat butiran dan harga.",
    ...
    why_1_title: "10+ Tahun Pengalaman", why_1_desc: "Dekad kepakaran HVAC merentasi hartanah kediaman dan komersial Lembah Klang.",
    ...
    footer_desc: "Penyamanan udara kediaman dan komersial premium merentasi Kuala Lumpur & Selangor. Diuruskan di bawah Multicore Dynamic Resources.",
  ...
  zh: {
    ...
    nav_book: "立即预约", nav_topbar: "当天冷气服务，覆盖吉隆坡及雪兰莪全区",
    hero_badge: "⭐ 谷歌地图评分 4.9 / 5 — 最高评价",
    hero_h1_line1: "专业冷气服务", hero_h1_line2: "吉隆坡 & 雪兰莪",
    hero_desc: "KL Renovator 提供优质住宅及商业冷暖气系统解决方案。专业化学清洗、化学大修、故障排除、漏水维修及冷媒充注。快速响应团队覆盖巴生谷全区。",
    hero_whatsapp: "通过 WhatsApp 预约", hero_call: "致电 +60 18-298 3573",
    hero_trust1: "当天预约上门", hero_trust2: "专业冷气技术员", hero_trust3: "透明收费，无隐藏费用",
    stats_customers: "巴生谷满意客户", stats_years: "年 HVAC 经验",
    stats_reviews: "五星级认证评价", stats_response: "紧急响应时间",
    services_eyebrow: "优质冷气解决方案", services_title1: "我们的专业 ", services_title2: "冷气服务",
    services_desc: "专业住宅及商业冷暖气服务，覆盖吉隆坡及雪兰莪。点击任何服务查看详情与价格。",
    ...
    why_1_title: "10 年以上经验", why_1_desc: "十年来服务巴生谷住宅及商业冷暖气系统的丰富经验。",
    ...
    footer_desc: "覆盖吉隆坡及雪兰莪的优质住宅及商业冷暖气服务，由 Multicore Dynamic Resources 管理。",
