...
export const translations = {
  ...
  ms: {
    ...
    homepage_ai_qa1_a: "Pemasangan dinding bermula dari RM 199 untuk 1.0–1.5 HP termasuk 7 kaki paip tembaga, pendawaian, paip saliran standard, vakum pam, dan waranti kerja 1 bulan. Ceiling cassette dari RM 290, unit tingkap dari RM 199. Semua harga disahkan sebelum kerja bermula.",
  ...
  zh: {
    ...
    homepage_ai_qa1_a: "挂壁式安装从RM 199起（1.0–1.5 HP），包含7英尺铜管、电线、排水管、标准支架、真空泵调试和1个月工艺保修。天花板卡式机RM 290起，窗式机RM 199起。所有价格在施工前确认。",
