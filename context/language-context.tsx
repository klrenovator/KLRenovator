...
export const translations = {
  en: {
    ...
    services_eyebrow: "Premium Aircond Solutions", services_title1: "Transparent ", services_title2: "Aircond Pricing",
    services_desc: "No hidden fees. Professional residential and commercial HVAC services across Kuala Lumpur and Selangor with upfront, competitive rates.",
  ...
  ms: {
    ...
    services_eyebrow: "Penyelesaian Aircond Premium", services_title1: "Harga Aircond ", services_title2: "Yang Telus",
    services_desc: "Tiada bayaran tersembunyi. Perkhidmatan HVAC profesional merentasi Kuala Lumpur dan Selangor dengan kadar kompetitif yang jelas.",
  ...
  zh: {
    ...
    services_eyebrow: "优质冷气解决方案", services_title1: "透明 ", services_title2: "冷气价格",
    services_desc: "无隐藏收费。专业住宅及商业冷暖气服务，覆盖吉隆坡及雪兰莪，提供透明竞争性价格。",
